...
typedef enum ObItemType
{
  ...
  T_TIME,
  //add 20120912:e
  T_MAXVALUE, //add wuna [MultiUps][sql_api] 20151217
  /* Reference type tags*/
  T_REF_COLUMN,
  T_REF_EXPR,
  T_REF_QUERY,
  ...
  T_ALTER_TABLE,
  //add by liu jun.[MultiUPS] [sql_api] 20150421:b
  T_TABLE_HASH_LIST,
  T_CREATE_PART_FUNC,
  T_DROP_PART_FUNC,
  T_FUNC_LIST,
  ...
  T_ALTER_TABLE_OPTION_LIST,
  T_TABLE_OPTION_ADD,
  T_TABLE_OPTION_ALTER,
  T_TABLE_OPTION_DROP,

  T_ALTER_VARCHAR_LENGTH,

  T_ALTER_DECIMAL_PRECISION,
