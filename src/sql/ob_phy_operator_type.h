...
namespace oceanbase
{
  namespace sql
  {
    enum ObPhyOperatorType
    {
      ...
      PHY_PART_EXECUTOR,
      //add 20150423:e
      //add lijianqiang [MultiUPS] [SELECT_MERGE] 20151231:b
      PHY_MULTI_UPS_MULTI_GET,
      PHY_MULTI_UPS_SCAN,
      PHY_REPLACE_COMPLETE_ROW_FUSE,
      PHY_REPLACE_SEMANTIC_FILTER,
      PHY_UPDATE_SEMANTIC_FILTER,
      PHY_INCOMPLETE_ROW_FILTER,
      //add 20151231:e
      //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20151229:b
      PHY_READ_ATOMIC_RPC_SCAN,
      //add duyr 20151229:e
	  PHY_UPDATE_DB_SEM_FILTER, // add lbzhong [Update rowkey] 20160418
      PHY_UPDATE_ROWKEY,
      PHY_ALTER_GROUP,
      PHY_GATHER_STATISTICS,
      PHY_CREATE_VIEW,
      PHY_DROP_VIEW,
