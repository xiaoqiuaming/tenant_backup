  ...
  namespace sql
  {
    ...
    class ObMultipleMerge : public ObPhyOperator
    {
      public:
        ...
        void set_is_return_current_fused_row(bool fuse_one_row)
        {is_return_current_fused_row_ = fuse_one_row;}
        //add 20160122:e
        //add duyr [Delete_Update_Function_isolation] [JHOBv0.1] 20160531:b
        ...
        void set_start_time (int64_t start_time )
        {
                ...
                YYSYS_LOG(DEBUG,"stmt_start_time_=%ld",stmt_start_time_);
        }
      ...
      protected:
        ...
        bool is_ups_row_;
        //add lijianqiang [MultiUPS] [PHYSICAL_PLAN_TRANSFORM] 20160122:b
        bool is_return_current_fused_row_;
        //add 20160122:e
        //add duyr [Delete_Update_Function_isolation] [JHOBv0.1] 20160531:b
