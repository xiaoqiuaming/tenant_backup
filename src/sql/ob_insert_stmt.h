...
namespace oceanbase
{
  namespace sql
  {
    ...
    public:
      ...
      void set_is_insert_multi_batch(bool is_insert_multi_batch)
      {is_insert_multi_batch_ = is_insert_multi_batch;}
      bool get_is_insert_multi_batch()
      {return is_insert_multi_batch_;}
