  ...
  namespace sql
  {
    class ObShowSchemaManager
    {
      ...
      private:
        ...
        //add:e
        static int add_show_all_index_schema(common::ObSchemaManagerV2 &schema_mgr);
        static int add_show_create_index_schema(common::ObSchemaManagerV2 &schema_mgr);
        ...
        static int add_show_create_view_schema(common::ObSchemaManagerV2 &schema_mgr);
        static int add_show_parameters_schema(common::ObSchemaManagerV2& schema_mgr);
        static int add_show_functions_schema(common::ObSchemaManagerV2& schema_mgr);//add liu jun.[MultiUPS] [sql_api] 20150325
        static int add_show_table_rules_schema(common::ObSchemaManagerV2& schema_mgr);//add wuna.[MultiUPS] [sql_api] 20160223
        static int add_show_groups_schema(common::ObSchemaManagerV2& schema_mgr);//add wuna.[MultiUPS] [sql_api] 20160223
        static int add_show_paxos_id_schema(common::ObSchemaManagerV2 &schema_mgr);
      ...
      private:        
        ...
        static yysys::CThreadMutex mutex_;
    };
  }
}
