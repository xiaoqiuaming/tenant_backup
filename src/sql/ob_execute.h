...
namespace oceanbase
{
  namespace sql
  {
    ...
    //add lijianqiang [MultiUPS] [PHYSICAL_PLAN_TRANSFORM] 20160223:b
    /**
     * in  EXECUTE stmt, need the newest partition manager for each time
     * when the stmt is being executed. In case the partition rules is
     * changed,ensure the rules is correct and can be used.
     */
    inline void ObExecute::set_sql_context(ObSqlContext * sql_context)
    {
