...
//add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160106:b
  ...
  namespace sql
  {
    class ObTableRpcScan: public ObTableScan
    {
      public:
        ...
        //add:e
        int get_rpc_row_desc(const common::ObRowDesc *&row_desc) const;
		...
		*/
        ...
        {return select_get_filter_.get_sub_query_expr(idx,expr,query_index);};
		...
		*/
        ...
        {return rpc_scan_.get_param_sub_query_expr(idx,expr,query_index);};
		...
		*/
        ...
        {return rpc_scan_.get_read_method();};
        //add 20140408:e
...
//        uint64_t get_mian_table_id (){return main_tid_ ;}
        //add duyr 20160531:e
      private:
        // disallow copy
      ...
      private:
        // data members
        //mod hongchen [UNPERMIT_ATOMIC] 20170821:b
        ////mod duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160106:b
        ObRpcScan rpc_scan_;
        //ObReadAtomicRpcScan rpc_scan_;
        ////mod duyr 20160106:e
        //mod hongchen [UNPERMIT_ATOMIC] 20170821:e
