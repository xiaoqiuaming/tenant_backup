...
namespace oceanbase
{
  namespace sql
  {
    ...
    class ObMergeJoin: public ObJoin
    {
      ...
      private:
        int join_with_right_row(const ObRow *&left_row,const ObRow *&right_row,const ObRow *&row,bool& if_continue);
        int join_with_right_cache_rows(const ObRow *&left_row,const ObRow *&row,bool& if_continue);
        int get_next_right_row(const ObRow *&left_row,const ObRow *&right_row,const ObRow *&row,bool& if_compare,bool &if_continue,bool& if_return);
        int do_left_or_right_join_rows(const ObRow &join_row,const ObRow *&join_result_row,bool is_left_row);
        int join_and_check_unequal_cond(const ObRow *&left_row,const ObRow &right_row,const ObRow *&join_result_row, const ObRowStore::MergejoinStoredRow *&stored_row,bool& if_satisfy_unequal_cond, bool& if_join_with_right_cache);
        int check_left_row_print(const ObRow *&left_row,const ObRow *&join_result_row,bool& if_get_next_left_row);
        int check_right_rows_print(const ObRow *&right_row,const ObRow *&row);
        int check_right_cache_print(const ObRow *&row);
      ...
      private:
        ...
        bool has_print_right_cached_row_end_;
        bool has_reset_right_cached_row_;
        bool is_equal_to_last_join_left_row_;
    };
  } // end namespace sql
