...
#include "ob_multi_ups_scan.h"//add lijianqiang [MultiUPS] [SELECT_MERGE] 20160105
  ...
  namespace sql
  {
    ...
    class ObTabletScan : public ObTabletRead
    {
      ...
      private:
        ...
        /* operator maybe used */
        //del lijianqiang [MultiUPS] [SELECT_MERGE] 20160111:b
        ...
        //add lijianqiang [MultiUPS] [SELECT_MERGE] 20160105:b
        ObMultiUpsScan op_multi_ups_scan_;
        //add 20160105:e
