...
//add e
//add liu jun. [MultiUPS] [part_cache] 20150627:b
  ...
  namespace sql
  {
    class ObPrivExecutor : public ObNoChildrenPhyOperator
    {
      ...
      private:
        ...
        int revoke_priv_from_table_privs_by_user_name_v2(const ObString &user_name,
                                                         const ObArray<ObPrivilegeType> *privileges);//add liumz, [bugfix: grant table level priv, revoke global level priv]20150902
