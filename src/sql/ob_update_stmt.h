...
namespace oceanbase
{
  namespace sql
  {
    ...
    public:
      ...
      void set_is_update_multi_batch(bool is_update_multi_batch)
      {is_update_multi_batch_ = is_update_multi_batch;};
      bool get_is_update_multi_batch()
      {return is_update_multi_batch_;};
      void set_num_of_questionmark_in_assignlist(int question_num)
      {questionmark_num_ = question_num; };
      int64_t get_questionmark_num_of_assignlist()
      {return questionmark_num_; };
      //add gaojt 20160302:e
      //add gaojt [Delete_Update_Function] [JHOBv0.1] 20160418:b
      void set_is_update_all_rowkey(bool is_update_all_rowkey)
      {is_update_all_rowkey_ = is_update_all_rowkey;};
      bool get_is_update_all_rowkey()
      {return is_update_all_rowkey_;};
  ...
  //          YYSYS_LOG(ERROR,"push next");
        }
        else//false  prevval
        {
            name_type.second = common::PREV_TYPE;
  //          YYSYS_LOG(ERROR, "push preval");
        }
