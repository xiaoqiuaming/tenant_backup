...
namespace oceanbase
{
  ...
  namespace sql
  {
    ObUpsResult::ObUpsResult() : allocator_(default_allocator_),
                                 ...
                                 memtable_version_(0),//add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150709
                                 k_(false)//add wangyao [sequence]:20171011
    {
    }
    ...
    int ObUpsResult::set_scanner(const ObNewScanner &scanner)
    {
      ...
      if (NULL == buffer)
      {
        YYSYS_LOG(WARN, "alloc memory fail");
        ret = OB_MEM_OVERFLOW;
      }
      else if (OB_SUCCESS != (ret = scanner.serialize(buffer, OB_MAX_PACKET_LENGTH, pos)))
      {
        YYSYS_LOG(WARN, "serialize scanner fail ret=%d buffer=%p len=%ld pos=%ld", ret, buffer, OB_MAX_PACKET_LENGTH, pos);
      }
      else
      {
    ...
    void ObUpsResult::clear()
    {
      ...
      trans_id_.reset();
      memtable_version_ = 0;
      k_ = false;//add wangyao[sequence for optimize]:20171011
    }
    ...
    int ObUpsResult::serialize_warning_list_(char* buf, const int64_t buf_len, int64_t& pos) const
    {
      ...
      {
        YYSYS_LOG(WARN, "serialize warning_count_ fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                  ret, buf, buf_len, pos);
      }
      ...
      while (NULL != iter)
      {
        ...
        {
          YYSYS_LOG(WARN, "serialize length fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, pos);
          break;
        }
        if (buf_len < (pos + iter->length))
        {
          YYSYS_LOG(WARN, "serialize warning string fail, buf=%p buf_len=%ld pos=%ld length=%ld",
    ...
    int ObUpsResult::deserialize_warning_list_(const char* buf, const int64_t data_len, int64_t& pos)
    {
      ...
      {
        YYSYS_LOG(WARN, "deserialize warning_count fail, ret=%d buf=%p data_len=%ld pos=%ld",
      ...
      for (int64_t i = 0; i < warning_count; i++)
      {
        ...
        {
          YYSYS_LOG(WARN, "deserialize length fail, ret=%d buf=%p data_len=%ld pos=%ld",
                    ret, buf, data_len, pos);
          break;
        }
        if (data_len < (pos + length))
        {
          YYSYS_LOG(WARN, "deserialize warning string fail, buf=%p data_len=%ld pos=%ld length=%ld",
    ...
    DEFINE_SERIALIZE(ObUpsResult)
    {
      ...
      while (OB_SUCCESS == ret)
      {
        ...
        {
          YYSYS_LOG(WARN, "serialize F_UPS_RESULT_START fail, ret=%d buf=%p buf_len=%ld pos=%ld",
        ...
        {
          YYSYS_LOG(WARN, "serialize F_ERROR_CODE fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        {
          YYSYS_LOG(WARN, "serialize error_code_ fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        {
          YYSYS_LOG(WARN, "serialize F_AFFECTED_ROWS fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        {
          YYSYS_LOG(WARN, "serialize affected_rows_ fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        {
          YYSYS_LOG(WARN, "serialize F_WARNING_LIST fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        {
          YYSYS_LOG(WARN, "serialize F_NEW_SCANNER fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        if (NULL != scanner_sel_buffer_)
        {
          ...
          {
            YYSYS_LOG(WARN, "serialize scanner_sel_buffer=%p scanner_sel_length=%ld fail, buf=%p buf_len=%ld pos=%ld",
        ...
        else
        {
          ...
          {
            YYSYS_LOG(WARN, "serialize scanner_ fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                      ret, buf, buf_len, tmp_pos);
            break;
          }
        }
        ...
        {
          YYSYS_LOG(WARN, "serialize F_TRANS_ID fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        ...
        // serialize memtable_version_ flag
        if (OB_SUCCESS != (ret = encode_i8(buf, buf_len, tmp_pos, F_MEMTABLE_VERSION)))
        {
          YYSYS_LOG(WARN, "serialize F_TRANS_ID fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        // serialize memtable_version_
        if (OB_SUCCESS != (ret = encode_i64(buf, buf_len, tmp_pos, memtable_version_)))
        {
          YYSYS_LOG(WARN, "serialize memtable_version_ fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
        //add 20150709:e
        ...
        {
          YYSYS_LOG(WARN, "serialize F_UPS_RESULT_END fail, ret=%d buf=%p buf_len=%ld pos=%ld",
                    ret, buf, buf_len, tmp_pos);
          break;
        }
    ...
    DEFINE_DESERIALIZE(ObUpsResult)
    {
      ...
      {
        YYSYS_LOG(WARN, "deserialize start_flag fail, ret=%d buf=%p data_len=%ld pos=%ld",
                  ret, buf, data_len, tmp_pos);
      }
      else if (F_UPS_RESULT_START != start_flag)
      {
        YYSYS_LOG(WARN, "start_flag=%lx do not mactch %lx, maybe this is not ObUpsResult",
      ...
      while (OB_SUCCESS == ret)
      {
        ...
        {
          YYSYS_LOG(WARN, "deserialize flag fail, ret=%d buf=%p data_len=%ld pos=%ld",
                    ret, buf, data_len, tmp_pos);
          break;
        }
        ...
        case F_ERROR_CODE:
          ...
          {
            YYSYS_LOG(WARN, "deserialize error_code_ fail, ret=%d buf=%p data_len=%ld pos=%ld",
                      ret, buf, data_len, tmp_pos);
          }
          break;
        case F_AFFECTED_ROWS:
          ...
          {
            YYSYS_LOG(WARN, "deserialize affected_rows_ fail, ret=%d buf=%p data_len=%ld pos=%ld",
                      ret, buf, data_len, tmp_pos);
          }
          break;
        case F_WARNING_LIST:
          ...
          {
            YYSYS_LOG(WARN, "deserialize warning_list_ fail, ret=%d buf=%p data_len=%ld pos=%ld",
                      ret, buf, data_len, tmp_pos);
          }
          break;
        case F_NEW_SCANNER:
          ...
          {
            YYSYS_LOG(WARN, "deserialize scanner_ fail, ret=%d buf=%p data_len=%ld pos=%ld",
                      ret, buf, data_len, tmp_pos);
          }
          break;
        case F_TRANS_ID:
          ...
          {
            YYSYS_LOG(WARN, "deserialize trans_id_ fail, ret=%d buf=%p data_len=%ld pos=%ld",
                      ret, buf, data_len, tmp_pos);
          }
          break;
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150709:b
        case F_MEMTABLE_VERSION:
          if (OB_SUCCESS != (ret = decode_i64(buf, data_len, tmp_pos, &memtable_version_)))
          {
            YYSYS_LOG(WARN, "deserialize trans_id_ fail, ret=%d buf=%p data_len=%ld pos=%ld",
                      ret, buf, data_len, tmp_pos);
          }
    ...
    DEFINE_GET_SERIALIZE_SIZE(ObUpsResult)
    {
      ...
      //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150709:b
      ret += encoded_length_i8(F_MEMTABLE_VERSION);
      ret += encoded_length_i64(memtable_version_);
      //add 20150709:e
