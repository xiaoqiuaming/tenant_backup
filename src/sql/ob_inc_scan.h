  ...
  namespace sql
  {
    ...
    class ObIncScan: public ObNoChildrenPhyOperator
    {
      ...
      public:
        ...
        void set_write_lock_flag()
        { lock_flag_ = (ObLockFlag)(lock_flag_ | LF_WRITE); }
        void set_cursor_unwrite_lock_flag()
        {
            lock_flag_ = (ObLockFlag)(lock_flag_ & LF_NONE);
            lock_flag_ = (ObLockFlag)(lock_flag_ | UNLF_WRITE);
        }//add gaojt [NPU-2015009-cursor] [NPU-OB-009] 20150410
        void set_cursor_write_lock_flag()
        {
            lock_flag_ = (ObLockFlag)(lock_flag_ & LF_NONE);
            lock_flag_ = (ObLockFlag)(lock_flag_ | LF_WRITE);
        }//add gaojt [NPU-2015009-cursor] [NPU-OB-009] 20150410
        void set_hotspot(bool flag)
        { hotspot_ = flag; }
        //add duyr [Delete_Update_Function_isolation] [JHOBv0.1] 20160531:b
        ...
        void set_is_hot_update(bool is_hot)
        {
            is_hot_update_ = is_hot;
        }
        // add by maosy e
        int serialize(char* buf, const int64_t buf_len, int64_t& pos) const;
        int deserialize(const char* buf, const int64_t data_len, int64_t& pos);
        int64_t get_serialize_size() const;
        void set_scan_type(const ScanType scan_type)
