  ...
  namespace sql
  {
    ...
    class ObSQLResultSet
    {
      ...
      public:
        ...
        { return errno_; }
        const ObString& get_sqlstr() const
        { return sqlstr_; }

        sql::ObResultSet& get_result_set()
        { return rs_; }
        void set_errno(int oberrno)
        { errno_ = oberrno; }
    ...
    inline int ObSQLResultSet::open()
    {
      ...
      {
        YYSYS_LOG(WARN, "fail to open result. ret = [%d]", ret);
      }
      return ret;
    }
    ...
    inline int ObSQLResultSet::close()
    {
      ...
      {
        YYSYS_LOG(WARN, "fail to close result. ret = [%d]", ret);
      }
      return ret;
    }
