...
//        }
        ...
        inline void set_read_atomic_param(const ObReadAtomicParam &param)
        {
      ...
      private:
        ...
        //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160121:b
        int filter_read_atomic_row_(const common::ObRow *input_row,
