...
namespace oceanbase
{
  ...
  namespace sql
  {
    ...
    class ObUpsResult
    {
      ...
      static const uint8_t F_MEMTABLE_VERSION = 0x06;
      //add 20150709:e
      struct StringNode
      {
        StringNode *next;
      ...
      public:
        ...
        {trans_id_ = trans_id;};
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150709:b
        void set_memtable_version(const int64_t version)
      ...
      public:
        ...
        {return trans_id_;};
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150709:b
        int64_t get_memtable_version()
        {return memtable_version_;}
        //add 20150709:e
        //add wangyao [sequence for optimize]:20171012
        void set_k() {k_=true;};
        bool get_k() {return k_;};
        //add e
      public:
        void clear();
      public:
      ...
      private:
        ...
        ObTransID trans_id_;
        int64_t memtable_version_;//add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150709
        bool k_;//add wangyao [sequence for optimize]:20171012
    };
  } // end namespace sql
