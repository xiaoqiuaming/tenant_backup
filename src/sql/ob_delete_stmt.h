...
namespace oceanbase
{
  namespace sql
  {
    ...
    public:
      ...
      void set_is_delete_multi_batch(bool is_delete_multi_batch)
      {is_delete_multi_batch_ = is_delete_multi_batch;};
      bool get_is_detete_multi_batch()
      {return is_delete_multi_batch_;};
      //add gaojt 20160307:e
      //add gaojt [Delete_Update_Function] [JHOBv0.1] 20160418:b
      void set_is_delete_all_rowkey(bool is_delete_all_rowkey)
      {is_delete_all_rowkey_ = is_delete_all_rowkey;};
      bool get_is_delete_all_rowkey()
      {return is_delete_all_rowkey_;};
    ...
    private:
      uint64_t table_id_;
      //add lijianqiang [sequence delete] 20150514:b
      common::ObArray<common::ObString> sequence_names_;//��ȥ�أ�ֻҪ���־�����
