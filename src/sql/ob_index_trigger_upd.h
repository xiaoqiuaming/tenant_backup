...
namespace oceanbase
{
    namespace sql
    {
        ...
        class ObIndexTriggerUpd: public ObSingleChildPhyOperator
        {
            ...
            {return index_num_;}
            //add e
            int handle_trigger(const ObSchemaManagerV2 *schema_mgr, updateserver::ObIUpsTableMgr* host, updateserver::RWSessionCtx &session_ctx, ObRowStore *store);
            ...
            void set_data_row_desc(common::ObRowDesc& desc,bool is_multi = false);
