...
namespace oceanbase
{
  namespace sql
  {
    ...
    public:
       ...
       void set_tmp_table(uint64_t subquery_id)
       { tmp_table_subquery_ = subquery_id; }
       void set_project_op(uint64_t subquery_id)
       { project_op_subquery_ = subquery_id; }
       void set_for_update(bool for_update);
       inline bool is_for_update()
       { return for_update_; }
