...
//        void remove_last_inexpr();
      ...
      void clear_simple_cond_filter_list();
      public:
      ...
      public://test
        ...
        int find_closed_column_range_simple_con(bool real_val,
        ...
        int find_closed_column_range_simple_btw(bool real_val,
                                                const ObRowkeyColumn *column,
                                                int64_t column_idx,
        ...
        int  resolve_close_column_range_in(bool real_val,
                                           const ObRowkeyColumn *column,
                                           ObObj cond_val,
                                           int64_t column_idx,
                                           int64_t idx_of_ranges,
