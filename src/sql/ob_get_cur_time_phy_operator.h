  ...
  namespace sql
  {
    ...
    class ObGetCurTimePhyOperator: public ObNoChildrenPhyOperator
    {
      public:
        ...
        inline void set_rpc_stub(mergeserver::ObMergerRpcProxy* rpc)
        {rpc_ = rpc;}
        inline void set_ups_plan(sql::ObPhysicalPlan *ups_plan)
        {ups_plan_ = ups_plan;}
...
//        inline void set_cur_time_fun_type(const ObCurTimeType& type) {cur_time_fun_type_ = type;}
        inline void set_cur_time_fun_type(const ObCurTimeType& type)
        {cur_time_fun_type_.push_back(type);}
        //mod 20150909:e
        virtual int open();
        ...
        virtual void reset();
        virtual void reuse();
        virtual int get_next_row(const common::ObRow *&)
        { return common::OB_NOT_SUPPORTED; }
        virtual int get_row_desc(const common::ObRowDesc *&) const
        { return common::OB_NOT_SUPPORTED; }
