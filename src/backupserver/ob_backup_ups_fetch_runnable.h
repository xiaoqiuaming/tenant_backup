  ...
  namespace backupserver
  {
    ...
    */
    ...
    public:
      ...
      virtual int init(const common::ObServer &master,
                       const char* log_dir,
                       const updateserver::ObUpsFetchParam &param,
                       updateserver::SSTableMgr *sstable_mgr,
                       ObBackupServer * server,
                       int64_t paxos_id = 0);


      int init(const ObServer &master, const char* log_dir, const ObFetchParam &param, int64_t paxos_id = 0, common::ObRoleMgr *role_mgr = NULL, common::ObLogReplayRunnable *replay_thread = NULL);
      ...
      bool get_backup_done()
      {
          return is_backup_done_;
      }
