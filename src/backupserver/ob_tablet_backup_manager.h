  ...
  namespace backupserver
  {
    ...
    class ObTabletBackupManager
    {
      ...
      public:
        ...
        inline bool backup_started()
        {return backup_start_;}
        inline void set_backup_thread(ObTabletBackupRunnable *thread)
        {backup_thread_ = thread;}
      ...
      private:
        ...
        mutable yysys::CThreadMutex task_thread_mutex_;

        //this for only one thread modify tablet_task_array_
        mutable yysys::CThreadMutex tablet_task_thread_mutex_;

        //every query task_array_ should rlock this
        mutable yysys::CRWLock task_thread_rwlock_;

        //every query tablet_task_array_ should rlock this
        mutable yysys::CRWLock tablet_task_thread_rwlock_;
