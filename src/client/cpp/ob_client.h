...
namespace oceanbase
{
  namespace client
  {
    ...
    class ReqList
    {
      public:
        int push_back(ObInnerReq *i_req)
        {
          ...
          if (OB_SUCCESS != ret)
          {
            YYSYS_LOG(ERROR, "ObList push_back error, ret=%d, "
    ...
    class ObClient : public yynet::IPacketHandler
    {
    public:
      /**
       * 连接OceanBase
...
//      int init_us_addr();
      ...
      yynet::IPacketHandler::HPRetCode
          handlePacket(yynet::Packet* packet, void * args);
    ...
    public:
      ...
      yynet::ConnectionManager connmgr_;
