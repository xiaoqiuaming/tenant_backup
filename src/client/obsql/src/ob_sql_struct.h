...
typedef struct ob_sql_mysql
{
  ...
  char buffer[sizeof(MYSQL) - 3*sizeof(ObSQLConn*) - sizeof(my_bool)
  - sizeof(int64_t) - sizeof(my_bool) - sizeof(my_bool) - sizeof(my_bool)
  - sizeof(my_bool) -sizeof(ObServerInfo) - sizeof(char*)];
} ObSQLMySQL;
