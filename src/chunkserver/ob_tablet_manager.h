  ...
  namespace chunkserver
  {
    ...
    class ObTabletManager
    {
      ...
      public:
        ...
        inline sstable::ObSSTableRowCache* get_row_cache() const
        { return sstable_row_cache_; }
      ...
      public:
        ...
        { return !is_init_; }
        inline bool is_disk_maintain()
        {return is_disk_maintain_;}

        void set_statistics_tid(const uint64_t tid);
    ...
    {
      //YYSYS_LOG(ERROR,"test::whx if_is_building_index[%ld]",index_beat_tid_);
