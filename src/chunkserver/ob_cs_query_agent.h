  ...
  namespace chunkserver
  {
    ...
    class ObCSQueryAgent: public common::ObIterator
    {
      ...
      public:
        ...
        inline void get_scan_param(common::ObScanParam *&param)
        {param = scan_param_;}
        inline void set_not_used(bool not_used = true)
        {not_used_ = not_used;}
        inline bool has_no_use()
        {return not_used_;}
        const RangeServerHash* get_range_server_hash()
        {return range_server_hash_;}
        void reset();
