...
#include "ob_multi_ups_scan_cell_streams.h"//add lijianqiang [MultiUPS] [MERGE]
...
namespace oceanbase
{
  namespace chunkserver
  {
    ...
    public:
      ...
      /**
       * get multi ups cell stream used for merge
       */
      ObMultiUpsScanCellStreams *get_multi_ups_scan_cell_streams();
      //add 20151209:e    
    ...
    private:
      ...
      //del 20160329:e
      //add lijianqiang [MultiUPS] [MERGE] 20151209:b
      ObMultiUpsScanCellStreams multi_ups_scan_cell_streams_;
      //add 20151209:e
