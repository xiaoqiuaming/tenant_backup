 ...
 *
 *  Version: $Id: ob_disk_path.cpp 2011��03��22�� 09ʱ54��22�� qushan Exp $
 *
 *  Authors:
...
namespace oceanbase
{
  namespace sstable
  {
    ...
    int get_config_item(const char *&data_dir, const char *&app_name)
    {
      ...
      {
        YYSYS_LOG(ERROR, "data dir has not been set.");
        ret = OB_ERROR;
      }
      else
      {
        ...
        {
          YYSYS_LOG(ERROR, "app name has not been set.");
          ret = OB_ERROR;
        }
      }
      return ret;
    ...
    int get_sstable_directory(const char* disk_path, char *path, const int64_t path_len)
    {
      ...
      {
        YYSYS_LOG(WARN, "get_sstable_directory invalid arguments, "
      ...
      else
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          {
            YYSYS_LOG(WARN, "get_sstable_directory, path_len=%ld <= bufsiz=%d", path_len, bufsiz);
    ...
    int get_recycle_directory(const char* disk_path, char *path, const int64_t path_len)
    {
      ...
      if (NULL == disk_path || NULL == path || path_len < 0)
      {
        YYSYS_LOG(WARN, "get_recycle_directory invalid arguments, "
            "disk_path=%p,path=%p,path_len=%ld", disk_path, path, path_len);
        ret = OB_INVALID_ARGUMENT;
      }
      else
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (bufsiz + 1 > path_len)
          {
            YYSYS_LOG(WARN, "get_recycle_directory , path_len=%ld <= bufsiz=%d", path_len, bufsiz);
            ret = OB_SIZE_OVERFLOW;
          }
        }
      }
    ...
    int get_recycle_path(const ObSSTableId& sstable_id, char *path, const int64_t path_len)
    {
      ...
      {
        YYSYS_LOG(WARN, "get_recycle_path invalid arguments, "
      ...
      else
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (disk_no < 0)
          {
            YYSYS_LOG(WARN, "get_recycle_path, sstable file id = %ld invalid",
          ...
          else
          {
            ...
            if (bufsiz + 1 > path_len)
            {
              YYSYS_LOG(WARN, "get_recycle_path, path_len=%ld <= bufsiz=%d",
                  path_len, bufsiz);
              ret = OB_SIZE_OVERFLOW;
            }
          }
    ...
    int get_sstable_path(const ObSSTableId& sstable_id, char *path, const int64_t path_len)
    {
      ...
      if (sstable_id.sstable_file_offset_ < 0 || NULL == path || path_len < 0)
      {
        YYSYS_LOG(WARN, "get_sstable_path invalid arguments, "
            "offset=%ld, path=%p,path_len=%ld",
            sstable_id.sstable_file_offset_, path, path_len);
        ret = OB_INVALID_ARGUMENT;
      }
      else
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (disk_no < 0)
          {
            YYSYS_LOG(WARN, "get_sstable_path, sstable file id = %ld invalid",
                sstable_id.sstable_file_id_);
            ret = OB_ERROR;
          }
          else
          {
            ...
            if (bufsiz + 1 > path_len)
            {
              YYSYS_LOG(WARN, "get_sstable_path, path_len=%ld <= bufsiz=%d",
                  path_len, bufsiz);
              ret = OB_SIZE_OVERFLOW;
            }
          }
    ...
    int get_tmp_meta_path(const int32_t disk_no, char *path, const int32_t path_len)
    {
      ...
      if (disk_no <= 0 || NULL == path ||  path_len <= 0)
      {
        YYSYS_LOG(WARN, "get_tmp_meta_path invalid arguments, "
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (bufsiz + 1 > path_len)
          {
            YYSYS_LOG(WARN, "get_meta_path, path_len=%d <= bufsiz=%d", path_len, bufsiz);
            ret = OB_SIZE_OVERFLOW;
          }
        }
      }
    ...
    int get_meta_path(const int32_t disk_no, const bool current, char *path, const int32_t path_len)
    {
      ...
      if (disk_no <= 0 || NULL == path ||  path_len <= 0)
      {
        YYSYS_LOG(WARN, "get_meta_path invalid arguments, "
            "disk_no=%d,path=%p,path_len=%d", disk_no, path, path_len);
        ret = OB_INVALID_ARGUMENT;
      }
        ...
        const bool current, char *path, const int32_t path_len)
    {
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (bufsiz + 1 > path_len)
          {
            YYSYS_LOG(WARN, "get_sstable_directory, path_len=%d <= bufsiz=%d", path_len, bufsiz);
            ret = OB_SIZE_OVERFLOW;
          }
        }
      }
      ...
      const int64_t path_len, const char* import_dir_name)
    {
      ...
      {
        YYSYS_LOG(WARN, "get_sstable_directory_helper invalid arguments, "
      ...
      else
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (bufsiz + 1 > path_len)
          {
            YYSYS_LOG(WARN, "get_sstable_directory_helper, path_len=%ld <= bufsiz=%d, "
      ...
      const char* import_dir_name)
    {
      ...
      {
        YYSYS_LOG(WARN, "get_import_sstable_path invalid arguments, "
      ...
      else
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (bufsiz + 1 > path_len)
          {
            YYSYS_LOG(WARN, "get_import_sstable_path, path_len=%ld <= bufsiz=%d, "
                            "import_dir_name=%s", 
