  ...
  namespace chunkserver 
  {
    ...
    class ObTabletImage
    {
      ...
      public:
        ...
        int delete_table(const uint64_t table_id, yysys::CRWLock& lock);
        ...
        { return ref_count_; }
        inline int64_t get_max_sstable_file_seq() const
        { return max_sstable_file_seq_; }
        inline int64_t get_data_version() const
        { return data_version_; }
        inline void set_data_version(int64_t version)
        ...
        inline int64_t incr_merged_tablet_count()
        { return __sync_add_and_fetch(&merged_tablet_count_, 1); }
        inline int64_t decr_merged_tablet_count()
        { return __sync_sub_and_fetch(&merged_tablet_count_, 1); }
        inline int64_t get_merged_tablet_count() const
        { return merged_tablet_count_; }
      ...
      private:
        ...
        mutable yysys::CThreadMutex alloc_mutex_;
    };
    ...
    class ObMultiVersionTabletImage 
    {
      ...
      public:
        ...
        //int upgrade_service();
        int upgrade_service(const bool is_really_merged = true);
        ...
        int get_tablets_for_merge(const int64_t current_frozen_version, 
            int64_t &size, ObTablet *tablets[], const bool need_unmerged = true) const;
        ...
        void get_tablet_merge_status(int64_t &tablet_num, int64_t &merged_num) const;
