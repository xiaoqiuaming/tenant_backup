...
namespace oceanbase
{
  namespace chunkserver
  {
                                                            ...
                                                            ObTablet*& tablet)
    {
      ...
      {
        YYSYS_LOG(WARN, "failed to acquire tablet, table_id=%lu, row_key: %s",
                                                  ...
                                                  ObSSTableReader* sstable_reader)
    {
      ...
      if (NULL == reader)
      {
        YYSYS_LOG(INFO, "start rowkey of old block in old tablet image "
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        if (OB_SUCCESS != ret)
        {
          YYSYS_LOG(DEBUG, "failed to get block position info, table_id=%lu, ret=%d, row_key: %s",
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        {
          YYSYS_LOG(WARN, "get block return unexpected block size, expected block "
