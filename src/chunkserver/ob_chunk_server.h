  ...
  namespace chunkserver
  {
    class ObChunkServer : public common::ObSingleServer
    {
      ...
      public:
        ...
        { return service_.schedule_report_tablet(); }

        //add liu jun. [MultiUPS] [part_cache] 20150528:b
        int64_t get_serving_data_version() const
        { return tablet_manager_.get_serving_data_version(); }
        ObPartitionMonitor *get_partition_monitor()
        { return part_monitor_; }
        //20150528:e
        //add lijianqiang [MultiUPS] [select_merge] b:
        int64_t get_frozen_version() const
        {return service_.get_frozen_version();}
        //add lijianqiang:e

        int serialize_cs_merge_stat(char *buf, const int64_t buf_len, int64_t &pos) const;
        ObChunkService &get_chunk_service()
        { return service_; }
