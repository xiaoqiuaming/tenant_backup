...
{ 
  namespace chunkserver 
  {
    ...
    int ObMergeReader::scan(const oceanbase::common::ObScanParam &scan_param) 
    {
      ...
      YYSYS_LOG(DEBUG, "ObMergeReader::scan begin");
      ...
      YYSYS_LOG(DEBUG, "ObMergeReader::scan acquire_tablet, ret=%d", ret);
      ...
      YYSYS_LOG(DEBUG, "ObMergeReader::scan finish, ret=%d,initialized_=%d", ret, initialized_);
      return ret;
    }
