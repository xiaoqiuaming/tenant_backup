...
namespace oceanbase
{
  ...
  namespace obmysql
  {
    ...
    public:
      ...
      //[739]
      inline int32_t get_conn_seq(){return conn_seq_;};
      inline void set_conn_seq(int32_t v){conn_seq_=v;};
      inline int64_t get_disconn_time(){return disconn_time_;};
      inline void set_disconn_time(int64_t v){disconn_time_=v;};
    ...
    private:
      ...
      int64_t receive_ts_;
      bool cleanup_;
      uint32_t conn_seq_;     //[739]
      uint64_t disconn_time_; //[739]
    };
