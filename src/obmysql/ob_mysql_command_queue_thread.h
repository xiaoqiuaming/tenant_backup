...
namespace oceanbase
{
  namespace obmysql
  {
    class ObMySQLCommandQueueThread : public yysys::CDefaultRunnable
    {
      public:
        ...
        void setThreadParameter(int threadCount, ObMySQLPacketQueueHandler* handler, void* args, bool nmclose=false);//[647]
      ...
      private:
        ...
        //yysys::CThreadCond pushcond_;
        timespec timeout_;
        bool wait_finish_;
        bool waiting_;
        common::IpPort ip_port_;
        common::ObServer host_;
        bool thd_name_close_;//[647]
    };
