...
namespace oceanbase 
{
  ...
  namespace sstable 
  {
    ...
    public:
      ...
      //add:e
      inline bool is_binary_rowkey() const
      { return NULL != binary_rowkey_info_; }
      ...
      inline int get_rowkey(common::ObRowkey& rowkey) const
      {
        ...
        {
          YYSYS_LOG(ERROR, "invalid argument, rowkey_obj_count_ = %ld, obj_count_ =%d, "
...
//      }
      ...
      inline int add_obj(const common::ObObj& obj)
      {
        ...
        {
          YYSYS_LOG(WARN, "can't add obj anymore, max_count=%ld, obj_count=%d", 
      ...
      inline int shallow_add_obj(const common::ObObj& obj, const uint64_t column_id)
      {
        ...
        if (column_id == common::OB_INVALID_ID
            || obj_count_ >= DEFAULT_MAX_COLUMN_NUMBER - 1)
        {
          YYSYS_LOG(WARN, "invalid column id or obj array full, "
      ...
      inline int shallow_add_rowkey_obj(const int64_t index, const uint64_t column_id)
      {
        ...
        {
          YYSYS_LOG(WARN, "invalid index argument, "
