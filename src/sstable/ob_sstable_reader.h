  ...
  namespace sstable
  {
    ...
    public:
      ObSSTableReader(common::ModuleArena &arena, common::IFileInfoMgr& fileinfo_cache,
        yysys::CThreadMutex* external_arena_mutex = NULL);
      ...
      { return is_opened_; }
      inline const ObSSTableId& get_sstable_id() const
      { return sstable_id_; }
      inline const common::ObNewRange& get_range() const
      { return trailer_.get_range(); }
    ...
    private:
      ...
      yysys::CThreadMutex* external_arena_mutex_;
      mutable yysys::CThreadMutex bf_mutex_;
