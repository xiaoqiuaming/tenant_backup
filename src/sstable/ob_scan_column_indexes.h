    ...
    class ObScanColumnIndexes
    {
      ...
      private:
        int allocate_store()
        {
          ...
          if (NULL == column_info_)
          {
            ...
            {
              YYSYS_LOG(WARN, "failed to allocate memory for column index array");
      ...
      public:
        ...
        inline int add_column_id(const ColumnType type, const int32_t index, const uint64_t column_id)
        {
          ...
          {
            YYSYS_LOG(WARN, "allocate_store error,ret=%d", ret);
          }
          else
          {
          ...
          {
            YYSYS_LOG(ERROR, "add column error, ret = %d, index=%d, column_id=%lu,"
    ...
    class ObSimpleColumnIndexes
    {
      ...
      public:
        ...
        inline int add_column(int64_t offset)
        {
          ...
          {
            YYSYS_LOG(WARN, "add too many columm cnt=%ld,size=%ld",
