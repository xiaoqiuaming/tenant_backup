  ...
  namespace sstable
  {
    class ObSSTableScanParam : public common::ObReadParam
    {
      public:
        ...
        inline void set_scan_flag(const common::ScanFlag& flag)
        { scan_flag_ = flag; }
        inline const common::ScanFlag get_scan_flag() const
        { return scan_flag_; }
    ...
    int ObSSTableScanParam::assign(const Param& param)
    {
      ...
      {
        YYSYS_LOG(WARN, "column_id_size=%ld too large", column_id_size);
