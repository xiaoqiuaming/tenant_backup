  ...
  namespace clustermanager
  {
    ...
    class OcmServer: public common::ObBaseServer
    {
      ...
      public:
        ...
        // for IServerAdaptor
        virtual yynet::IPacketHandler::HPRetCode handlePacket(yynet::Connection *connection, yynet::Packet *packet);
        // for IServerAdaptor
        virtual bool handleBatchPacket(yynet::Connection *connection, yynet::PacketQueue &packetQueue);
      private:
