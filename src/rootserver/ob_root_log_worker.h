  ...
  namespace rootserver
  {
    ...
    class ObRootLogWorker
    {
      ...
      public:
        ...
        //mod zhaoqiong [MultiUPS] [MS_CS_Manage_Function] 20150529:b
        ...
        int regist_cs(const common::ObServer& server, const char* server_version, const int64_t timestamp, const int64_t cluster_id);
        int regist_ms(const common::ObServer& server, int32_t sql_port, const char* server_version, const int64_t timestamp, const int64_t cluster_id);
        int regist_lms(const common::ObServer& server, int32_t sql_port, const char* server_version, const int64_t timestamp, const int64_t cluster_id);
        int server_is_down(const common::ObServer& server, const int64_t timestamp, const int64_t cluster_id);
        //mod:e
        //add zhaoqiong [MultiUPS] [MS_CS_Manage_Function] 20150529:b
        int server_is_down_ms(const common::ObServer& server, int32_t sql_port, const int64_t timestamp, const int64_t cluster_id);
        //add:e
      ...
      private:
        ...
        int log_server_with_ts(const common::LogCommand cmd, const common::ObServer& server, const char* server_version, const int64_t timestamp, const int64_t cluster_id= -1);
        //mod:e
      ...
      public:
        ...
        int do_set_bypass_version(const char* log_data, const int64_t& log_length); //[conflict leve A]
        ...
        //mod zhaoqiong [MultiUPS] [MS_CS_Manage_Function] 20150529:b
        int do_ms_down(const char* log_data, const int64_t& log_length);
        //mod:e
        ...
        int do_set_load_table_status(const char* log_data, const int64_t& log_length);//[conflict leve A]
