...
namespace oceanbase
{
  namespace rootserver
  {
    ...
    //add:e     
    static const int OB_RS_ADMIN_ENABLE_LOAD_DATA = 25;

    static const int OB_RS_ADMIN_GATHER_STATISTICS = 26;

    static const int OB_RS_ADMIN_STOP_GATHER_STATISTICS = 27;
