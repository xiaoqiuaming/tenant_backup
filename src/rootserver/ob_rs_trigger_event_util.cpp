...
int ObRootTriggerUtil::slave_boot_strap(ObTriggerEvent & trigger)
{
  ...
  if (err != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "fail to trigger slave_boot_strap event. err[%d]", err);
  }
  else
  {
    YYSYS_LOG(TRACE, "trigger slave_boot_strap event succ");
  }
  return err;
}
*/
...
int ObRootTriggerUtil::slave_create_all_checksum(ObTriggerEvent & trigger)
{
  ...
  if (err != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "fail to trigger create slave all_ccheck_sum. err[%d]", err);
  }
  else
  {
    YYSYS_LOG(TRACE, "trigger create slave all_ccheck_sum succ");
  }
  return err;
}
//add e
...
int ObRootTriggerUtil::notify_slave_refresh_schema(ObTriggerEvent & trigger)
{
  ...
  if (err != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "fail to trigger notify_slave_refresh_schema event. err[%d]", err);
  }
  else
  {
    YYSYS_LOG(TRACE, "trigger notify_slave_refresh_schema event succ");
  }
  return err;
}
*/
...
int ObRootTriggerUtil::create_table(ObTriggerEvent & trigger, const uint64_t table_id)
{
  ...
  if (err != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "fail to trigger create_table event. err[%d]", err);
  }
  else
  {
    YYSYS_LOG(TRACE, "trigger create_table event succ");
  }
  return err;
}
*/
...
int ObRootTriggerUtil::alter_table(ObTriggerEvent & trigger)
{
  ...
  if (err != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "fail to trigger alter_table event. err[%d]", err);
  }
  else
  {
    YYSYS_LOG(TRACE, "trigger alter_table event succ");
  }
  return err;
}
*/
...
int ObRootTriggerUtil::drop_tables(ObTriggerEvent & trigger, const uint64_t table_id)
{
  ...
  if (err != OB_SUCCESS)
  {
    YYSYS_LOG(WARN, "fail to trigger drop_table event. err[%d]", err);
  }
  else
  {
    YYSYS_LOG(TRACE, "trigger drop_table event succ");
  }
  return err;
}
*/
