  ...
  namespace rootserver
  {
    ...
    class ObRootBalancer
    {
      public:
        ...
        void set_ddl_operation_mutex(yysys::CThreadMutex *mutex_lock);
        void set_root_table(ObRootTable2 *root_table);
        void set_root_table_lock(yysys::CRWLock *root_table_rwlock);
        void set_root_table_build_mutex(yysys::CThreadMutex* root_table_build_mutex);
        void set_server_manager(ObChunkServerManager *server_manager);
        void set_server_manager_lock(yysys::CRWLock *server_manager_rwlock);
        void set_schema_manager(common::ObSchemaManagerV2 *schema_manager);
        void set_schema_manager_lock(yysys::CRWLock *schema_manager_rwlock);
        ...
        void set_balancer_thread(ObRootBalancerRunnable *balancer_thread)
        {balancer_thread_ = balancer_thread;}
        ...
        void set_stop()
        { receive_stop_ = true; }
        yysys::CRWLock& get_load_data_lock(){ return load_data_lock_; }
        //add lbzhong [Paxos Cluster.Balance] 201607014:b
        void set_cluster_manager(ObRootClusterManager *cluster_mgr);
        void set_cluster_manager_lock(yysys::CRWLock *cluster_mgr_rwlock);
        ObRootServer2* get_root_server() const
        { return root_server_;}
        void print_balancer_info(const int64_t table_id);
        //add:e
        //add peiouya [MultiUPS] [MS_CS_Manage_Function] 20150512:b
        void update_using_cluster_info();
        //add 20150512:e
...
//                            , int64_t &tablet_count, bool &tablet_lost_flag
        ...
        void stop_failed_load_table_task(bool &is_finished);
      ...
      private:
        ...
        yysys::CRWLock *root_table_rwlock_;
        yysys::CThreadMutex *root_table_build_mutex_; //any time only one thread can modify root_table
        yysys::CRWLock *server_manager_rwlock_;
        yysys::CRWLock load_data_lock_;
        ...
        //add:e
        int32_t balance_per_cluster_dest_start_pos_[OB_MAX_CLUSTER_COUNT];
    };
    ...
    inline void ObRootBalancer::set_ddl_operation_mutex(yysys::CThreadMutex *mutex_lock)
    {
    ...
    inline void ObRootBalancer::set_root_table_lock(yysys::CRWLock *root_table_rwlock)
    {
      root_table_rwlock_ = root_table_rwlock;
    }
    inline void ObRootBalancer::set_root_table_build_mutex(yysys::CThreadMutex* root_table_build_mutex)
    {
    ...
    inline void ObRootBalancer::set_server_manager_lock(yysys::CRWLock *server_manager_rwlock)
    {
    ...
    inline void ObRootBalancer::set_cluster_manager_lock(yysys::CRWLock *cluster_mgr_rwlock)
    {
