...
//add:e
#include "rootserver/ob_root_delete_table_rules_task.h"//add wuna [MultiUps] [sql_api] 20160421
#include "rootserver/ob_root_scale_task.h" //add liuzy [MultiUPS] [init_new_master_rs] 20160304
...
namespace oceanbase
{
  ...
  {
    struct RootReStartParam
    {
      int64_t restart_paxos_num_;
      int64_t restart_clu_num_;
      RootReStartParam()
        : restart_paxos_num_(0), restart_clu_num_(0)
      {
      }
      void init()
      {
        restart_paxos_num_ = 0;
        restart_clu_num_ = 0;
      }
    };
    class ObRootWorker :public common::ObBaseServer, public common::ObPacketQueueHandler
    {
      public:
        ...
        //yynet::IPacketHandler::HPRetCode handlePacket(easy_request_t *connection, yynet::Packet *packet);
        ...
        //add:e
        RootReStartParam &get_restart_param()
        {
          return restart_param_;
        }
      private:
        int start_as_master();
        int start_as_slave();
        ...
        //add peiouya [MultiUPS] [UPS_Manage_Function] 20150429:b     //[uncertainty ]
        int rt_get_update_server_info_by_paxos_id(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff,
        ...
        */
        ...
        int rt_slave_get_G_K_param(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_major_freeze(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20150609:e
        int rt_minor_freeze(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_get_all_ups_list(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_get_master_ups_list(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20150528:e

        int rt_force_get_sys_table_ups_list(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_fetch_cs_info(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
     //add zhaoqiong [MultiUPS] [MS_Manage_Function] 20150611:b
        int rt_get_master_ms_list(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add:e
        //add liuzy [MultiUPS] [add_paxos_interface] 20160112:b
        int rt_add_paxos_group(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20160112:e
        int rt_del_paxos_group(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        
        //add liuzy [MultiUPS] [take_paxos_offline_interface] 20160222:b
        int rt_take_paxos_group_offline(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20160222:e
        //add liuzy [MultiUPS] [take_paxos_offline_interface] 20160229:b
        int rt_get_current_paxos_usable_view(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20160229:e
        //add liuzy [MultiUPS] [add_cluster_interface] 20160311:b
        int rt_add_cluster(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_renew_ups_manager(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        
        int rt_renew_ups_manager_delete(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);

        int rt_reload_slave_rs_config(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        
        int rt_del_cluster(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20160311:e
        //add liuzy [MultiUPS] [take_cluster_offline_interface] 20160325:b
        int rt_take_cluster_offline(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20160325:e
        //add liuzy [MultiUPS] [take_online_interface] 20160418:b
        int rt_take_paxos_group_online(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_take_cluster_online(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add 20160418:e
        //add 20150528:e
        ...
        //add:e
        int rt_alter_group(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        //[view]
        int rt_create_view(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_drop_view(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        //add:e
        int rt_rs_admin_slave_set_rs_leader(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_get_replica_num(const int32_t version,
            ...
            const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add:e
        int rs_get_ups_memory(const int32_t version, common::ObDataBuffer& in_buff,
                              easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_get_table_replica_num(const int32_t version,
            ...
            const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add:e
        int rt_execute_range_collection(const int32_t version,
                                        common::ObDataBuffer& in_buff, easy_request_t* req,
                                        const uint32_t channel_id, common::ObDataBuffer& out_buff);

        int rt_get_statistics_task(const int32_t version,
            common::ObDataBuffer& in_buff, easy_request_t* req,
            const uint32_t channel_id, common::ObDataBuffer& out_buff);
        ...
        int rt_get_rs_stat(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);

        //add bingo [Paxos Cluster.Flow.UPS] 20170405:
        //mod pangtianze [Paxos Cluster.Flow.UPS] 20170405 change func name, from 'rt_sync_is_strong_consistent' to new
        int rt_slave_set_ups_config_params(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        //add:e
        int rt_check_is_master_rs(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_get_rs_local_timestamp(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_fetch_index_merge_stat(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rs_dump_unusual_tablets(const int32_t version, common::ObDataBuffer& in_buff, easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
      ...
      private:
        ...
        int slave_compare_G_K_with_master_();
      ...
      protected:
        ...
        ObRootInitClusterStat refresh_rs_offline_stat_task_;//add liuzy [MultiUPS] [init_new_master_rs] 20160530
        ObRootInnerTableTask inner_table_task_;
        ObRsAfterRestartTask after_restart_task_;
        ObRootTableRulesDeleteTask table_rules_delete_duty_;//add wuna [MultiUps] [sql_api] 20160421
        ObTimer timer_for_delete_table_rules_;//add wuna [MultiUPS] [sql_api] 20160421
        ObTimer timer_;
        //add huangjianwei [Paxos rs_switch] 20160727:b
        ...
        //add e
        RootReStartParam restart_param_;
    };
    //add pangtianze [Paxos rs_election] 20150717:b
