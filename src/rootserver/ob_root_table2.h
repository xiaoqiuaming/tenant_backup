  ...
  namespace rootserver
  {
    ...
    class ObRootTable2
    {
      ...
      public:
        ...
        inline iterator sorted_end()
        { return begin() + sorted_count_; }

        inline const_iterator begin() const
        { return &(data_holder_[0]); }
        inline const_iterator end()  const
        { return begin() + meta_table_.get_array_index(); }
        inline const_iterator sorted_end() const
        { return begin() + sorted_count_; }
        ...
        //int get_deleted_table(const common::ObSchemaManagerV2 & schema, common::ObArray<uint64_t>& deleted_tables) const;
        // mod e
        ...
        int32_t find_suitable_pos(const const_iterator& it, const int32_t server_index,
        ...
        int32_t find_suitable_pos2(const const_iterator& it, const int32_t server_index,
            const int64_t tablet_version, int32_t &cluster_id, common::ObTabletReportInfo *to_delete = NULL);
        
        bool check_root_server();
    ...
    inline bool ObRootTable2::check_root_server()
    {
      return (NULL != root_server_);
    }
    inline void ObRootTable2::set_root_server(ObRootServer2 *root_server)
    {
