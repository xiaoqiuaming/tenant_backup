  ...
  namespace rootserver
  {
    class ObRootLogManager : public common::ObLogWriter
    {
      ...
      public:
        ...
        const char* get_log_dir_path() const
        { return log_dir_; }
        inline uint64_t get_replay_point()
        {return replay_point_;}
        inline uint64_t get_check_point()
        {return ckpt_id_;}

        ObRootLogWorker* get_log_worker()
        { return &log_worker_; }
        yysys::CThreadMutex* get_log_sync_mutex()
      ...
      private:
        ...
        yysys::CThreadMutex log_sync_mutex_;
    };
  } /* rootserver */
} /* oceanbase */
