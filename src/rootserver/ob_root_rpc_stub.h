    ...
    class ObRootRpcStub : public common::ObCommonRpcStub
    {
      public:
        ...
        virtual int slave_register(const common::ObServer &master,
                                   ...
                                   int64_t &paxos_num,
                                   int64_t &quorum_scale,
                                   const int64_t timeout);
        //mod:e
        
        virtual int slave_get_G_K_param(const common::ObServer& master,
        ...
        virtual int switch_partition_stat(const common::ObServer& server, const int64_t &mem_version);
        ...
        virtual int get_ups_mem_msg(const common::ObServer& ups, int64_t &mem_size, const int64_t timeout_us);
        ...
        virtual int send_rs_heartbeat_resp(const int32_t version, const common::ObServer &rs,
                                           common::ObMsgRsHeartbeatResp &msg);
        ...
        //virtual int execute_sql(const ObServer &ms, const ObString &sql_stmt, ObSQLResultSet &rs);
        virtual int execute_sql(const ObServer &ms, const ObString &sql_stmt, ObSQLResultSet &rs,const int64_t timeout = 3000000);
        //add 20160413:e
        //mod 20170922:e
        ...
        virtual int get_collection_stat(const common::ObServer &cs, const int64_t time_out, bool &is_over, float &progress);
        ...
        virtual int get_range_collection_list_from_ms(const ObServer ms, const int64_t timeout, const int64_t data_version, int64_t start, int64_t end, ObArray<uint64_t> *list);
        ...
        /**
         * @brief send_ups_config_params
         * @param rs
         * @param timeout_us
         * @param is_strong_consistent
         * @param read_master_master_ups_percentage
         * @return
         */
        int send_ups_config_params(const common::ObServer &rs, const int64_t timeout_us, const int64_t is_strong_consistent
                                   //add pangtianze [Paxos CLuste.Flow.UPS] 20170802:b
                                   ,const int32_t read_master_master_ups_percentage
                                   //add:e
                                   );
        //add:e
        //         //uncertainty  add for rpc
        //        int get_master_ups_info( const ObServer& root_server, ObServer &master_ups,const int64_t timeout_uss) const;

        //add liuzy [MultiUPS] [add_cluster_interface] 20160316:b
        int send_new_ups_manager(const common::ObServer &rs, common::ObDataBuffer &data_buffer);

        int send_new_ups_manager_delete(const common::ObServer &rs, common::ObDataBuffer &data_buffer);

        int send_reload_slave_rs_config(const common::ObServer &rs, common::ObDataBuffer &data_buffer);
        //add 20160316:e
        
        int get_thread_buffer(common::ObDataBuffer &data_buffer)
        {
          int ret = OB_SUCCESS;
          ret = get_thread_buffer_(data_buffer);
          return ret;
        }
