...
namespace oceanbase
{
  namespace rootserver
  {
    ...
    public:
      ...
      inline void set_root_table_build_mutex(yysys::CThreadMutex* root_table_build_mutex)
      {
        root_table_build_mutex_ = root_table_build_mutex;
      }
      inline void set_server_manager_rwlock(yysys::CRWLock* server_manager_rwlock)
      {
        server_manager_rwlock_ = server_manager_rwlock;
      }
      inline void set_root_table_rwlock(yysys::CRWLock* root_table_rwlock)
      {
    ...
    private:
      ...
      yysys::CThreadMutex* root_table_build_mutex_;
