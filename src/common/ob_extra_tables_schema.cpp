...
int ObExtraTablesSchema::all_all_column_schema(TableSchema& table_schema)
{
  ...
  ADD_COLUMN_SCHEMA("nullable", //column_name
                    ...
                    sizeof(int64_t), //column length
                    false); //is nullable
  //add for [column default]-b
  ADD_COLUMN_SCHEMA("column_default", //column_name
                    column_id ++, //column_id
                    0, //rowkey_id
                    ObVarcharType,  //column_type
                    OB_MAX_DEBUG_MSG_LEN, //column length
                    true); //is nullable
  //add for [column default]-e
  ADD_COLUMN_SCHEMA("gm_create", //column_name
                    OB_CREATE_TIME_COLUMN_ID, //column_id
                    0, //rowkey_id
                    ObCreateTimeType,  //column_type
...
int ObExtraTablesSchema::all_partition_rules(TableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_ALL_PARTITION_RULES_NAME);
  table_schema.table_id_ = OB_ALL_PARTITION_RULES_TID;
  table_schema.rowkey_column_num_ = 1;
  table_schema.max_used_column_id_ = OB_APP_MIN_COLUMN_ID + 4;
  table_schema.max_rowkey_length_ = sizeof(int64_t);
...
int ObExtraTablesSchema::all_table_rules(TableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_ALL_TABLE_RULES_NAME);
  table_schema.table_id_ = OB_ALL_TABLE_RULES_TID;
  table_schema.rowkey_column_num_ = 2;
  table_schema.max_used_column_id_ = OB_APP_MIN_COLUMN_ID + 9;
  table_schema.max_rowkey_length_ = sizeof(int64_t);
  ...
  ADD_COLUMN_SCHEMA("reserver_field1", //column_name
                    ...
                    OB_MAX_TABLE_NAME_LENGTH, //column length
                    false); //is nullable
  ADD_COLUMN_SCHEMA("reserver_field2", //column_name
                    column_id ++, //column_id
                    0, //rowkey_id
                    ObIntType,  //column_type
                    sizeof(int64_t), //column length
...
int ObExtraTablesSchema::all_all_group(TableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_ALL_ALL_GROUP_NAME);
  table_schema.table_id_ = OB_ALL_ALL_GROUP_TID;
  table_schema.rowkey_column_num_ = 2;
  table_schema.max_used_column_id_ = OB_APP_MIN_COLUMN_ID + 4;
  table_schema.max_rowkey_length_ = sizeof(int64_t);;
...
int ObExtraTablesSchema::ups_session_info_schema(TableSchema& table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_UPS_SESSION_INFO_NAME);
  table_schema.table_id_ = OB_UPS_SESSION_INFO_TID;
  //table_schema.rowkey_column_num_ = 3;
  table_schema.rowkey_column_num_ = 4;
  table_schema.max_rowkey_length_ = TEMP_ROWKEY_LENGTH;
  ...
  ADD_COLUMN_SCHEMA("commit_stat",
                    column_id++,
                    0,
                    ObBoolType,
                    sizeof (bool),
                    false);
  ADD_COLUMN_SCHEMA("group_info",
                    column_id++,
                    0,
                    ObVarcharType,
                    OB_MAX_RESULT_MESSAGE_LENGTH,
                    false);
  return ret;
}
//add 20150701:e
//add liuzy [MultiUPS] [take_cluster_offline_interface] 20160325:b
int ObExtraTablesSchema::all_cluster_stat_info_schema(TableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_ALL_CLUSTER_STAT_INFO_TABLE_NAME);
  table_schema.table_id_ = OB_ALL_CLUSTER_STAT_INFO_TID;
  table_schema.rowkey_column_num_ = 2;
  table_schema.max_rowkey_length_ = TEMP_ROWKEY_LENGTH;
  table_schema.max_used_column_id_ = OB_APP_MIN_COLUMN_ID + 5;
  ...
  ADD_COLUMN_SCHEMA("version",
                    ...
                    sizeof (int64_t),
                    false);
  ADD_COLUMN_SCHEMA("name",
                    column_id++,
                    2,
                    ObVarcharType,
                    OB_MAX_RESULT_MESSAGE_LENGTH,
                    false);
  ADD_COLUMN_SCHEMA("use_num",
                    column_id++,
                    0,
                    ObIntType,
                    sizeof (int64_t),
                    false);
  ADD_COLUMN_SCHEMA("stat_info",
                    column_id++,
                    0,
                    ObIntType,
                    sizeof (int64_t),
                    false);
  ADD_COLUMN_SCHEMA("new_stat_info",
                    column_id++,
                    0,
                    ObIntType,
                    sizeof (int64_t),
...
int ObExtraTablesSchema::all_change_cluster_paxos_schema(TableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_ALL_CHANGE_CLUSTER_PAXOS_TABLE_NAME);
  table_schema.table_id_ = OB_ALL_CHANGE_CLUSTER_PAXOS_TID;
  table_schema.rowkey_column_num_ = 2;
  table_schema.max_rowkey_length_ = sizeof(ObDateTimeType) + sizeof(int64_t);
  table_schema.max_used_column_id_ = OB_APP_MIN_COLUMN_ID + 8;

  table_schema.replica_num_ = OB_MAX_COPY_COUNT;
  int column_id = OB_APP_MIN_COLUMN_ID;

  ADD_COLUMN_SCHEMA("op_time",                 //column_name
                    column_id++,               //column_id
                    1,                         //rowkey_id
  ...
  ADD_COLUMN_SCHEMA("op_client",               //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObVarcharType,             //column_type
                    OB_MAX_COLUMN_NAME_LENGTH, //column length
  ...
  ADD_COLUMN_SCHEMA("op_type",                 //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObInt32Type,               //column_type
                    sizeof(ObInt32Type),       //column length
                    false);                    //is nullable

  ADD_COLUMN_SCHEMA("op_cmd",                  //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObVarcharType,             //column_type
                    OB_MAX_COLUMN_NAME_LENGTH, //column length
  ...
  ADD_COLUMN_SCHEMA("op_result",               //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObInt32Type,               //column_type
                    sizeof(ObInt32Type),       //column length
...
int ObExtraTablesSchema::all_udi_monitor_list(TableSchema &table_schema)
{
  int ret = OB_SUCCESS;
  table_schema.init_as_inner_table();
  ...
  ADD_COLUMN_SCHEMA("LOAD",                    //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObBoolType,                //column_type
                    sizeof(bool),              //column length
                    false);                    //is nullable

  ADD_COLUMN_SCHEMA("UDI",                     //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObIntType,                 //column_type
                    sizeof(int64_t),           //column length
...
//add for [statistic info materialization]-b
int ObExtraTablesSchema::all_statistic_info(TableSchema &table_schema)
{
  ...
  ADD_COLUMN_SCHEMA("start_key",               //column_name
                    ...
                    3,                         //rowkey_id
                    ObVarcharType,             //column_type
                    OB_MAX_ROW_KEY_LENGTH,     //column length
                    false);                    //is nullable
  ...
  ADD_COLUMN_SCHEMA("different_num",           //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObIntType,                 //column_type
                    sizeof(int64_t),           //column length
  ...
  ADD_COLUMN_SCHEMA("min_max",                 //column_name
                    column_id++,               //column_id
                    0,                         //rowkey_id
                    ObVarcharType,             //column_type
                    OB_MAX_ROW_KEY_LENGTH * 2, //column length
                    true);                     //is nullable

  return ret;
}
//add for [statistic info materialization]-e

//[view]
int ObExtraTablesSchema::all_view_schema(TableSchema &table_schema)
{
    int ret = OB_SUCCESS;
    table_schema.init_as_inner_table();
    strcpy(table_schema.table_name_, OB_ALL_VIEW_TABLE_NAME);
    table_schema.table_id_ = OB_ALL_VIEW_TID;
    table_schema.rowkey_column_num_ = 1;
    table_schema.max_used_column_id_ = OB_APP_MIN_COLUMN_ID + 4;
    table_schema.max_rowkey_length_ = sizeof(int64_t);
    table_schema.replica_num_ = OB_MAX_COPY_COUNT;
    ...
    ADD_COLUMN_SCHEMA("view_id",                //column_name
                      column_id++,               //column_id
                      1,                         //rowkey_id
                      ObIntType,                 //column_type
                      sizeof(int64_t),           //column length
    ...
    ADD_COLUMN_SCHEMA("check_option",                //column_name
                      column_id++,               //column_id
                      0,                         //rowkey_id
                      ObIntType,                 //column_type
                      sizeof(int64_t),           //column length
    ...
    ADD_COLUMN_SCHEMA("is_updatable",                //column_name
                      column_id++,               //column_id
                      0,                         //rowkey_id
                      ObIntType,                 //column_type
                      sizeof(int64_t),           //column length
    ...
    ADD_COLUMN_SCHEMA("view_definition",                //column_name
                      ...
                      0,                         //rowkey_id
                      ObVarcharType,                 //column_type
                      OB_MAX_SQL_LENGTH,           //column length
                      false);                    //is nullable
