  ...
  namespace common
  {
    ...
    class ObGetParam : public ObReadParam
    {
       ...
       */
        ...
        inline bool get_deep_copy_args() const
        {
          return deep_copy_args_;
        }
        //add 20150714:e
       ...
       */
        ...
        int add_row(const uint64_t table_id,const ObRowkey *row_key,const ObArray<uint64_t> & basic_columns);
        //add 20150806::e
       ...
       */
        ...
        //add shili [MultiUPS] [PHYSICAL_PLAN_TRANSFORM] 20150714:b
        //@berif 根据get_param  的table_id
        inline int get_table_id(uint64_t &table_id) const
        {
          int ret = OB_SUCCESS;
          if(NULL == cell_list_)
          {
          ...
          {
            table_id = cell_list_[0].table_id_;
          }
          return ret;
        }
        //add 20150714:e
       ...
       */
        ...
        { schema_manager_ = sm; }
        inline bool is_binary_rowkey_format() const
        { return is_binary_rowkey_format_; }
        ...
        //add for [322-truncate sstable get]-b
        inline void set_table_truncate()
        { is_table_truncated_ = true; }
        inline bool get_table_truncate() const
        { return is_table_truncated_; }
        //add for [322-truncate sstable get]-e
      ...
      private:
        ...
        //      ObTransID trans_id_;
        //      //add:e
        bool is_table_truncated_; //add for [322-truncate sstable get]

    };


    //add shili [MultiUPS] [PHYSICAL_PLAN_TRANSFORM] 20150714:b
    //@berif  用于存储 ObGetParam中同一个paxos组的所用行
    struct ObSubGetParam
    {
        ObSubGetParam():paxos_id_(-1)
        {
          get_param_.reset(true);
        }
        ~ObSubGetParam()
        {
          get_param_.~ObGetParam();
        }
        void reset()
        {
          paxos_id_ = -1;
        ...
        ObGetParam  get_param_;    //careful!must free the mem of ObGetParam!!!!
        int64_t paxos_id_;
    }
    //add 20150714:e
    ;
