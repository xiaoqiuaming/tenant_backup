...
oceanbase::common::ObRoleMgr* __rs_role_mgr = NULL;   //[uncertainty ]
...
#define __debug_init__() __ups = this; __ups_role_mgr = &role_mgr_ /*__ups_obi_role = &obi_role_*/; __log_mgr = &log_mgr_; // uncertainty  ups obi role 删除
