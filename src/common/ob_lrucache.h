    ...
    class ObLruCache
    {
      ...
      public:
        int init(int64_t max_cache_num, int64_t min_gc_timeo)
        {
          ...
          {
            YYSYS_LOG(WARN, "invalid param max_cache_num=%ld min_gc_timeo=%ld", max_cache_num, min_gc_timeo);
            ret = OB_ERROR;
          }
          else if (0 != hashmap_.create(max_cache_num))
          {
            YYSYS_LOG(WARN, "create hashmap fail hash_item_num=%lu", max_cache_num);
            ret = OB_ERROR;
          }
          else
          {
      ...
      public:
        ...
        // get֮��黹��cache,��ʾ���Ա�lru���ջ�free��,��getһһ��Ӧ
        // @param [in] cache���ݵ�ID
        // @return OB_SUCCESS �ɹ�
        //         OB_ERROR ʧ��
        ...
        // ���cacheû������ֱ�ӷ��سɹ�
        // @param [in] cache���ݵ�ID
        // @param [in] flag LC_RELEASE_IMMED ���ɾ��ʧ���򷵻ش���
        //                  LC_RELEASE_DELAY ���ɾ��ʧ�����ǵ�revert���Զ�ɾ��
        // @return OB_SUCCESS �ɹ�
