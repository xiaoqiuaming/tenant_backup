                             ...
                             ObClientManager *client, const int64_t band_limit)
{
  ...
  {
    YYSYS_LOG(WARN, "rpc_buffer is null");
    ret = OB_INVALID_ARGUMENT;
  }

  if(OB_SUCCESS == ret && NULL == client)
  {
    YYSYS_LOG(WARN, "client is null");
    ret = OB_INVALID_ARGUMENT;
  }

  if(OB_SUCCESS == ret && band_limit < MIN_BAND_LIMIT)
  {
    YYSYS_LOG(WARN, "Ob file service band limit[%ld] should not less than %ld KB/s",
                                ...
                                ObDataBuffer& in_buffer, ObDataBuffer& out_buffer,int64_t& session_id)
{
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Serialize file info failed:ret=[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Serialize dest_dir failed:ret=[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Serialize dest_file_name:ret=[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Send the send_file_request failed:ret=[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Deserialize result code failed:ret = [%d]", ret);
    }
    else if (OB_SUCCESS != rc.result_code_)
    {
      ret = rc.result_code_;
      YYSYS_LOG(WARN, "failed to prepare for send file:ret =[%d].",
                                  ...
                                  ObDataBuffer& in_buffer, ObDataBuffer& out_buffer,const int64_t session_id)
{
  ...
  if (OB_SUCCESS != err)
  {
    YYSYS_LOG(WARN, "Read file block failed");
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Encode rc failed:rc.result_code_[%d], ret[%d]",
                rc.result_code_, ret);
    }
  }
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Encode offset failed:offset[%ld], ret[%d]", offset, ret);
    }
  }
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Encode block buf failed:ret[%d], "
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Send the send_file_request failed:ret=[%d] timeout[%ld]",
                ret, timeout);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    {
      ret = rc.result_code_;
      YYSYS_LOG(WARN, "Send file block response failed:result_code=[%d]",
                rc.result_code_);
    }
  }
                                ...
                                ObDataBuffer& out_buffer,const int64_t session_id)
{
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Send the send_file_end  failed:ret=[%d]", ret);
    }
  }
  int64_t pos = 0;
  if (OB_SUCCESS == ret)
  {
    ...
    {
      ret = rc.result_code_;
      YYSYS_LOG(WARN, "Get response of sned-file_end failed:result code=[%d]",
                rc.result_code_);
    }
  }
  return ret;
                                 ...
                                 const ObString& dest_file_name)
{
  ...
  if (band_limit > band_limit_)
  {
    ...
    YYSYS_LOG(WARN, "the band limit param of send file client[%ld] is"
  ...
  if (band_limit <= 0)
  {
    YYSYS_LOG(ERROR, "the band limit param should not be [%ld]",
              band_limit);
    ret = OB_INVALID_ARGUMENT;
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (NULL == block_buffer)
    {
      ...
      YYSYS_LOG(WARN, "Allocate memory for block buffer failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    {
      YYSYS_LOG(WARN, "get file size of %.*s failed: %s",
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "Open file for send_file failed. path=[%.*s] ret=[%d]",
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(ERROR, "Do send_file_pre failed: ret[%d]", ret);
    }
  }
  ...
  while(OB_SUCCESS == ret)
  {
    ...
    else
    {
      ...
      if (read_size > 0)
      {
        cost_time_us = yysys::CTimeUtil::getTime() - start_time_us;
      ...
      if (offset == file_size)
      {
        ...
        if (OB_SUCCESS != ret)
        {
          YYSYS_LOG(ERROR, "failed to send_file_end:ret=[%d]", ret);
        }
      ...
      else if(offset > file_size)
      {
        ...
        YYSYS_LOG(WARN, "Send file offset error [%ld] "
  ...
  {
    YYSYS_LOG(ERROR, "duration time of send file should not be zero:"
  ...
  if (OB_SUCCESS == ret)
  {
    YYSYS_LOG(INFO, "Send file local_path[%.*s] to dest_server[%s] dest_dir[%.*s] "
  ...
  {
    YYSYS_LOG(ERROR, "Send file local_path[%.*s] to dest_server[%s] dest_dir[%.*s] "
