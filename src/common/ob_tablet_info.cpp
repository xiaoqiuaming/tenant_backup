...
namespace oceanbase
{
  namespace common
  {
    ...
    {
      //      YYSYS_LOG(INFO,"tablet_version :%ld, tablet_seq: %ld, location:%s\n",
      //                location.tablet_version_, location.tablet_seq_, to_cstring(location.chunkserver_));
      YYSYS_LOG(DEBUG,"tablet_version :%ld, tablet_seq: %ld, location:%s, cluster_id:%d\n",
                location.tablet_version_, location.tablet_seq_, to_cstring(location.chunkserver_),location.cluster_id_);
    }
    //mod:e
