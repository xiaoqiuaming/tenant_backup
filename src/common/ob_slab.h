  ...
  namespace common
  {
    ...
    class ObSlabCache
    {
      public:
        ...
        int clear();
        const char *get_slab_name() const
        { return slab_name_;}
      ...
      public:
        ...
        { return obj_size_; }
        int64_t get_obj_per_slab() const
        { return obj_per_slab_;}

        int64_t get_slabs_full_num()    const
        { return slabs_full_num_;  }
        int64_t get_slabs_partial_num() const
        { return slabs_partial_num_;}
        int64_t get_slabs_free_num ()   const
        { return slabs_free_num_;  }
        int64_t get_total_inuse_objs()  const
        { return total_inuse_objs_;}
        int64_t get_alloc_slab_count()  const
        { return alloc_slab_count_;}
        int64_t get_free_slab_count ()  const
        { return free_slab_count_; }
        int64_t get_alloc_item_count()  const
        { return alloc_item_count_;}
        int64_t get_free_item_count ()  const
        { return free_item_count_; }
      ...
      private:
        ...
        yyutil::Monitor<yyutil::Mutex> lock_;
