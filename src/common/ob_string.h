    ...
    class ObString
    {
      ...
      public:
        ...
        */
         ...
         * ��һ����ptr��ʶ��, ��СΪ size, �����Ѿ������� length �������� ��buf ��ʼ��
         */
         ...
         * ��ob_string ������һ�鲻�����Լ����ڴ�ռ���, �� obstring �ɶ�,����д
         */
         ...
         * ���Լ�hold buffer��ʱ��, ��buffer�л�ûʹ�õĳ���
         * �������Ǳ���һ��ָ���ʱ��, ����0
         */
        ...
        inline bool concat( const ObString& src1, const ObString& src2,const char s = '.',int32_t start = 0)
        {
          ...
          {
            YYSYS_LOG(WARN,"concat input [start:%d],but data_length is:%d, not valid",start,data_length_);
            return false;
          }
          if(src1.length() > 0)
          {
      ...
      inline const char* find(const char c) const
      {
        ...
        static ObString int_to_str(const int val)
        {
          char str[common::OB_MAX_TABLE_NAME_LENGTH];
        ...
        {
          bool flag = true;
          for (int32_t i = 0; i < data_length_; ++i)
          {
            int32_t temp = ptr_[i] - '0';
            if ( i == 0 && temp == 0)
            {
              flag = false;
              break;
        ...
        bool str_is_datetime(int type)
        {
          ...
          else
          {
            ...
            if (flag)
            {
              ...
              if (type == 1)
              {
                matched = sscanf(ptr_, "%4d-%2d-%2d %2d:%2d:%2d",
                                 &year, &month, &day,
                                 &hour, &minute, &second);
                if (matched != 6)
                {
