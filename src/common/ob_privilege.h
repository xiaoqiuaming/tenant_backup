  ...
  namespace common
  {
    ...
    class ObPrivilege
    {
      ...
      public:
        ...
        //add for [471-ob_export with username and passwd]-b
        int user_is_valid_for_obexport(const ObString &username, const ObString &password) const;
        //add for [471-ob_export with username and passwd]-e
        /**
        ...
        NameUserMap* get_username_map()
        { return &username_map_; }
        UserPrivMap* get_user_table_map()
        { return &user_table_map_; }
        //add dolphin [database manager]@20150607
        const NameDbMap* get_database_name_map() const
        { return &name_database_map_; }
        UserDbPriMap* get_user_database_privilege_map()
        { return &user_database_pri_map_; }
        const UserDbPriMap* get_user_database_privilege_map_const() const
        { return &user_database_pri_map_; }
        const NameUserMap* get_username_map_const() const
        { return &username_map_; }
        TableDbMap*  get_table_database_map()
        { return &table_database_map_; }
        //add:e
