  ...
  namespace common
  {
    ...
    struct ObFirstTabletEntryTable::MyRow: public ObTabletMetaTableRow
    {
      public:
        ...
        {}
        // getter & setters    
        const ObString& get_meta_table_name() const
        { return this->meta_table_name_; }
        void set_meta_table_name(const ObString &meta_table_name)
        { this->meta_table_name_ = meta_table_name; }
        const uint64_t& get_meta_tid() const
        { return this->meta_tid_; }
        void set_meta_tid(const uint64_t &meta_tid)
        { this->meta_tid_ = meta_tid; }
        const TableSchema::TableType& get_table_type() const
        { return this->table_type_; }
        void set_table_type(const TableSchema::TableType &table_type)
