                                           ...
                                           ObTabletLocationList & location)
{
  ...
  ret = rpc_stub_->fetch_tablet_location(rpc_timeout_, root_server_, 0,
                                         ...
                                         //modify for [ms unavailable bugfix]-b
        ...
        else
        {
            ...
            //add:e
          {
            ...
            if (OB_SUCCESS == ret)
            {
              ...
              //ObTabletLocation addr(0, server); //del zhaoqiong [MultiUPS] [RootTable_Cache] 20150703
            }
          }
          //add zhaoqiong [MultiUPS] [RootTable_Cache] 20150703:b
                   ...
                   || (cell->column_name_.compare("6_tablet_version") == 0))
          {
            ...
            YYSYS_LOG(DEBUG,"tablet_version is %ld, rowkey:%s",tablet_version, to_cstring(cell->row_key_));
            //add:e
          }
