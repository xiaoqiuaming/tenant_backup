...
namespace oceanbase
{
  namespace common
  {
    ...
    protected:
      uint64_t lock_size_;
      yysys::CThreadMutex * lock_holder_;
    };
    ...
    public:
      ...
      yysys::CThreadMutex * acquire_lock(const uint64_t id);
    };
    ...
    public:
      ...
      yysys::CThreadMutex * acquire_lock(void);
      // for test return the lock index
      yysys::CThreadMutex * acquire_lock(uint64_t & index);
    private:
