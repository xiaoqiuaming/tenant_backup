  ...
  namespace common
  {
    class ObActionFlag
    {
      public:
        ...
        static const int64_t OP_COLUMN_DELETE         = 21; //add shili, [MultiUPS] [COLUMN_VERSION_MERGE]  20170423
        ...
        static const int64_t SQL_STMT_TYPE   = 93;
        //add 20150612:e
        //add lijianqiang [MultiUPS] [SELECT_MERGE] 20151228:b
        /// ObNewScanner row version verctor
        static const int64_t ROW_VERSION_FIELD = 94;
        //add 20151228:e
        //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20151201:b
        static const int64_t READ_ATOMIC_PARAM_FIELD  = 95;
        //add duyr 20151201:e
        // add by maosy [MultiUPS 1.0][read uncommit] 20170525
        static const int64_t TRANS_ID_FIELD = 96 ;
        // add by maosy 
        //add by maosy [MultiUps 1.0] [secondary index optimize] 20170722 b:
        static const int64_t OB_STATEMENT_BARRIER= 97 ;
        // add by maosy e
    };
  } /* common */
} /* oceanbase */
