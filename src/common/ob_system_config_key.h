...
namespace oceanbase
{
  namespace common
  {
    ...
    inline ObSystemConfigKey::ObSystemConfigKey()
      : name_(), cluster_id_(OB_ALL_CLUSTER_FLAG), server_port_(0), version_(0)
    {
    ...
    inline bool ObSystemConfigKey::match(const ObSystemConfigKey &other) const
    {
      ...
      ret = (this == &other
             || (0 == strcmp(name_, other.name_)
                 && (cluster_id_ == other.cluster_id_ || cluster_id_ == OB_ALL_CLUSTER_FLAG)
                 && ((0 == strcmp(server_type_, other.server_type_))
    ...
    {
      return match(other) && cluster_id_ != OB_ALL_CLUSTER_FLAG;
    }
