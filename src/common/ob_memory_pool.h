 ...
 *   Ϊ�˱��ڵ����ڴ�����bug�������������Ϊ__OB_MALLOC_DIRECT__�Ļ���������
 *   �ڴ�ؽ�ֱ�ӵ���new��delete������ͷ��ڴ�
 *
 */
...
namespace oceanbase
{
  namespace common
  {
    ...
    class ObBaseMemPool
    {
      ...
      protected:
        /// @property mutex
        mutable yysys::CThreadMutex pool_mutex_;
    ...
    /// @class  ObVarMemPool ��ͨ�ñ䳤�ڴ��
    /// @author wushi(wushi.ly@taobao.com)  (8/25/2010)
    /// @warning ���ڴ�ز���ͨ�õı䳤�ڴ�أ�ͨ�õ��ڴ������ʹ��common/ob_malloc.h�еĽӿ�
    ///          �ڴ�����õĵط���ǰֻ��������У������Ҫʹ�ø��ڴ������ϵ���߳�ֵ��˽�
    ///          ʵ�ֻ��ƣ��Ӷ�ȷ���Ƿ��ʺ�ʹ�ó�����ͬʱ�û�����ȷ�����ڴ�ص�ʹ�ÿ�����
    ///          һ��class���ڲ�
    /// @note -# ���뱣֤��ObVarMemPool�з�����ڴ��ܹ������ͷ�
    ///       -# ��ͨ���ڴ�أ����������ʹ�÷�Χ��ʹ��ǰ����ϵwushi.ly@taobao.com
