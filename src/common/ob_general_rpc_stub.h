  ...
  namespace common
  {
    ...
    class ObGeneralRpcStub : public ObDataRpcStub
    {
      ...
      public:
        ...
        int fetch_master_server_list(const int64_t timeout, const common::ObServer & root_server,
                                     common::ObUpsList & server_list) const;
        //add 20150528:e

        int force_fetch_sys_table_update_server_list(const int64_t timeout, const common::ObServer &root_server,
                                                     common::ObUpsList &server_list) const;
        ...
        int alter_group(const int64_t timeout, const common::ObServer &root_server,
        ...
        //[view]
        int create_view(const int64_t timeout, const common::ObServer & root_server,
                        bool do_replace, const common::TableSchema &table_schema) const;

        int drop_view(const int64_t timeout, const common::ObServer & root_server,
        ...
        //delete for [secondary index get old cchecksum opt]-e
        //mod:e
        //add e
        ...
        //add for [mult backup recovery]-b
        int fetch_rs_last_frozen_version(const int64_t timeout, const ObServer &root_server,
                                         int64_t &last_version) const;
        //add for [mult backup recovery]-e
        ...
        int ups_get_stmt_start_time(const int64_t timeout,const ObServer &ups,
                                    int64_t &publised_transid) const;
        // add by maosy e
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150701:b
        /**
         * @brief ms send end distributed trans request to coordinator UPS
         * @param timeout
         * @param ups coordinator UPS
         * @param req all participants info
         * @return
         */
        int ups_end_dis_trans(const int64_t timeout, const ObServer & ups,
                              const ObEndTransReq &req) const;
        /**
         * @brief rollback sub transaction
         * @param timeout
         * @param ups participant
         * @param trans_id sub transaction id
         * @return
         */
        int ups_rollback_trans(const int64_t timeout, const ObServer & ups,
                               const ObTransID &trans_id) const;
        /**
         * @brief 2PC, coordinator send prepare to participant
         * @param timeout
         * @param ups participant
         * @param req contain participant trans id and coordinator trans id
         * @return
         */
        int ups_prepare_trans(const int64_t timeout, const ObServer & ups,
                              const ObEndTransReq &req) const;
        /**
         * @brief 2PC, coordinator send commit to participant
         * @param timeout
         * @param ups participant
         * @param trans_id participant trans id
         * @return
         */
        int ups_commit_trans(const int64_t timeout, const ObServer & ups,
                             const ObTransID &trans_id) const;
        /**
         * @brief participant send prepare success to coordinator
         * @param timeout
         * @param ups coordinator
         * @param trans_id coordinator trans id
         * @param participant
         * @return
         */
        int ups_response_preapre_ack(const int64_t timeout, const ObServer & ups,
                                     const ObTransID &trans_id, const ObServer &participant, const bool is_rollback = false) const;
        /**
         * @brief system UPS send write trans stat record success to coordinator
         * @param timeout
         * @param ups coordinator
         * @param trans_id coordinator trans id
         * @param commit system UPS record commit or not
         * @return
         */
        int ups_write_trans_stat_ack(const int64_t timeout, const ObServer & ups,
                                     const ObTransID &trans_id, const bool commit) const;
        /**
         * @brief participant check coordinator transaction exist stat
         * @param timeout
         * @param trans_id coordinator trans id
         * @param [out] coordinator_exist result of coordinator transaction exist stat
         * @return
         */
        int find_session_exist(const int64_t timeout, const common::ObTransID& trans_id, bool &coordinator_exist);
        //add 20150701:e

        //add for [handle unsetted trans]-b
        int is_coordinator_master_ups_tmplog_replay_finished(const int64_t timeout, const ObServer &coordinator_master_ups, bool &tmplog_replay_finished);
