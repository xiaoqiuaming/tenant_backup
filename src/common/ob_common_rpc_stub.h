  ...
  namespace common
  {
    class ObCommonRpcStub
    {
      public:
        ...
        virtual int get_master_ups_info_by_paxos_id(const ObServer& rs, ObServer &master_ups, const int64_t paxos_id, const int64_t timeout_us);
        //add 20150429:e  //[uncertainty ]:e
        ...
        /**
         * @brief send disributed transaction final stat to system UPS
         * @param update_server :system UPS
         * @param trans_id : distributed transaction transid
         * @param commit :trans stat; if commit trans, need check memtable version, else no need
         * @param memtable_version: current distributed trans mem version
         * @return if serialize error, return serialize error code,
         *         else return post request error code
         */
        virtual int mutate_distribute_stat(const ObServer& update_server, const ObTransID& trans_id,
