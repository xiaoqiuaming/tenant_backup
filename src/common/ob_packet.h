...
namespace oceanbase
{
  namespace common
  {
    enum PacketCode
    {
      ...
      OB_GET_MASTER_MS_LIST = 255,
      OB_GET_MASTER_MS_LIST_RESPONSE = 256,
      //add:e
      ...
      //add for [cs merge stat]-b
      OB_CS_FETCH_MERGE_STAT = 267,
      OB_CS_FETCH_MERGE_STAT_RESPONSE = 268,
      OB_CS_FETCH_LOCAL_INDEX_STAT = 269,
      OB_CS_FETCH_LOCAL_INDEX_STAT_RESPONSE = 270,
      //add for [cs merge stat]-e
      ...
      //add for [nmon ups memtable]-b
      OB_GET_UPS_MEMORY = 376,
      OB_GET_UPS_MEMORY_RESPONSE = 377,
      OB_SEND_GET_UPS_MEM = 378,
      OB_SEND_GET_UPS_MEM_RESPONSE = 379,
      //add for [nmon ups memtable]-e

      //del peiouya [MultiUPS] [UPS_SYNC_Frozen] 20150528:b
      //OB_UPDATE_SERVER_REPORT_FREEZE = 267,
      //del 20150528:e
      //add for [handle unsetted trans]-b
      OB_GET_UPS_TMPLOG_REPLAY_FINISHED = 380,
      OB_GET_UPS_TMPLOG_REPLAY_FINISHED_RESPONSE = 381,
      //add for [handle unsetted trans]-e
      //add for [503-get rs stat]-b
      OB_GET_RS_STAT = 382,
      OB_GET_RS_STAT_RESPONSE = 383,
      //add for [503-get rs stat]-e

      //add for [statistics build]-b
      OB_EXECUTE_RANGE_COLLECTION = 384,
      OB_EXECUTE_RANGE_COLLECTION_RESPONSE = 385,
      OB_GET_STATISTICS_TASK = 386,
      OB_GET_STATISTICS_TASK_RESPONSE = 387,
      //add for [statistics build]-e
      ...
      //add for [491-check parameters when rs reboot]-b
      OB_SLAVE_GET_G_K_PARAM = 331,
      OB_SLAVE_GET_G_K_PARAM_RES = 332,
      //add for [491-check parameters when rs reboot]-e
      ...
      OB_ALTER_GROUP = 508,
      OB_ALTER_GROUP_RESPONSE = 509,
      //add for [alter group]-e

        //[view]
        OB_CREATE_VIEW = 510,
        OB_CREATE_VIEW_RESPONSE = 511,
        OB_DROP_VIEW = 512,
        OB_DROP_VIEW_RESPONSE = 513,
      ...
      //add:e
      //add for [cs merge stat]-b
      OB_RS_FETCH_CS_INFO = 626,
      OB_RS_FETCH_CS_INFO_RESPONSE = 627,
      OB_RS_FETCH_INDEX_MERGE_STAT = 628,
      OB_RS_FETCH_INDEX_MERGE_STAT_RESPONSE = 629,
      //add for [cs merge stat]-e
      ...
      OB_SEND_UPS_CONFIG_PARAMS = 639,
      OB_SEND_UPS_CONFIG_PARAMS_RESPONSE = 640,
      //add:e
      ...
      //add for [statistics info]-b
      OB_PUT_ANALYSISED_TABLE_SINFO_INTO_CACHE = 710,
      OB_PUT_ANALYSISED_TABLE_SINFO_INTO_CACHE_RESPONSE = 711,
      OB_PUT_ANALYSISED_COLUMN_SINFO_INTO_CACHE = 712,
      OB_PUT_ANALYSISED_COLUMN_SINFO_INTO_CACHE_RESPONSE = 713,
      //add for [statistics info]-e
      ...
      //add for [cbtop]-b
      OB_RS_GET_ALL_UPS_LIST = 1600,
      OB_RS_GET_ALL_UPS_LIST_RESPONSE = 1601,
      OB_UPS_GET_MEM_TABLE_INFO = 1602,
      OB_UPS_GET_MEM_TABLE_INFO_RESPONSE = 1603,
      OB_UPS_GET_COMMIT_LOG_STAT = 1604,
      OB_UPS_GET_COMMIT_LOG_STAT_RESPONSE = 1605,
      OB_RS_GET_LOCAL_TIMESTAMP = 1610,
      OB_RS_GET_LOCAL_TIMESTAMP_RESPONSE = 1611,
      //add for [cbtop]-e

      //[682]-b
      OB_DUMPRT_REQUEST_REPORT_TABLET = 1612,
      OB_DUMPRT_REQUEST_REPORT_TABLET_RESPONSE = 1613,
      //[682]-e
      ...
      OB_UPS_ASYNC_MAJOR_FREEZE_MEMTABLE_ACCORD_HB = 2800,
      //add 20150521:e
      //add peiouya [MultiUPS] [DELETE_OBI] 20150701:b
      OB_UPS_ASYNC_GET_SYS_UPS_MASTER = 2801,
      //add 20150701:e
      ...
      OB_RS_ADD_PAXOS_GROUP = 3023,
      OB_RS_ADD_PAXOS_GROUP_RESPONSE = 3024,
      //add 20160112:e
      //add liuzy [MultiUPS] [take_paxos_offline_interface] 20160222:b
      OB_RS_TAKE_PAXOS_GROUP_OFFLINE = 3025,
      OB_RS_TAKE_PAXOS_GROUP_OFFLINE_RESPONSE = 3026,
      OB_RS_TAKE_CLUSTER_OFFLINE = 3027,
      OB_RS_TAKE_CLUSTER_OFFLINE_RESPONSE = 3028,
      OB_RS_GET_CURRENT_PAXOS_USABLE_VIEW = 3029,
      OB_RS_GET_CURRENT_PAXOS_USABLE_VIEW_RESPONSE = 3030,
      //add 20160222:e
      //add liuzy [MultiUPS] [add_cluster_interface] 20160311:b
      OB_RS_ADD_CLUSTER = 3031,
      OB_RS_ADD_CLUSTER_RESPONSE = 3032,
      OB_RS_SYNC_NEW_UPS_MANAGER = 3033,
      OB_RS_SYNC_NEW_UPS_MANAGER_RESPONSE = 3034,
      //add 20160311:e
      //add liuzy [MultiUPS] [take_online_interface] 20160418:b
      OB_RS_TAKE_PAXOS_GROUP_ONLINE = 3035,
      OB_RS_TAKE_PAXOS_GROUP_ONLINE_RESPONSE = 3036,
      OB_RS_TAKE_CLUSTER_ONLINE = 3037,
      OB_RS_TAKE_CLUSTER_ONLINE_RESPONSE = 3038,
      OB_RS_RELOAD_SLAVE_RS_CONFIG = 3039,
      OB_RS_RELOAD_SLAVE_RS_CONFIG_RESPONSE = 3040,
      //add 20160418:e

      //add for [516-enhance dump unusual tablets]-b
      OB_RS_DUMP_UNUSUAL_TABLETS = 3041,
      OB_RS_DUMP_UNUSUAL_TABLETS_RESPONSE = 3042,
      //add for [516-enhance dump unusual tablets]-e

      //add for [513-del cluster paxos]-b
      OB_RS_DEL_PAXOS_GROUP = 3043,
      OB_RS_DEL_PAXOS_GROUP_RESPONSE = 3044,
      OB_RS_DEL_CLUSTER = 3045,
      OB_RS_DEL_CLUSTER_RESPONSE = 3046,
      OB_RS_SYNC_NEW_UPS_MANAGER_DELETE = 3047,
      OB_RS_SYNC_NEW_UPS_MANAGER_DELETE_RESPONSE = 3048,
      //add for [513-del cluster paxos]-b
      // sql
      OB_SQL_EXECUTE = 4000,
      ...
      OB_END_DISTRIBUTED_TRANS = 4010,
      OB_END_DISTRIBUTED_TRANS_RESPONSE = 4011,
      OB_TRANS_PREPARE_ACK = 4012,
      OB_TRANS_PREPARE_ACK_RESPONSE = 4013,
      //2PC
      OB_ROLLBACK_TRANSACTION = 4014,
      OB_ROLLBACK_TRANSACTION_RESPONSE = 4015,
      OB_PREPARE_TRANSACTION = 4016,
      OB_PREPARE_TRANSACTION_RESPONSE = 4017,
      OB_COMMIT_TRANSACTION = 4018,
      OB_COMMIT_TRANSACTION_RESPONSE = 4019,
      OB_WRITE_TRANS_STAT = 4020,
      OB_WRITE_TRANS_STAT_RESPONSE = 4021,
      OB_WRITE_TRANS_STAT_ACK = 4022,
      OB_WRITE_TRANS_STAT_ACK_RESPONSE = 4023,
      OB_CHECK_SESSION_EXIST = 4024,
      OB_CHECK_SESSION_EXIST_RESPONSE = 4025,
      //add 20150106:e
        //add by maosy [MultiUps 1.0] [batch_iud_snapshot] 20170622 b:
        OB_GET_PUBLICED_TRANCEID ,
        //add by e
      ...
      //add for [449-optimize partition flag]-b
      OB_SWITCH_PARTITION_STAT = 6004,
      OB_SWITCH_PARTITION_STAT_RESPONSE = 6005,
      //add for [449-optimize partition flag]-e
      // import data source
      ...
      //add peiouya [MultiUPS] [UPS_Manage_Function] 20150427:e
      OB_GET_UPDATE_SERVER_INFO_BY_PAXOS_ID,
      OB_GET_UPDATE_SERVER_INFO_BY_PAXOS_ID_RESPONSE,
      //add 20150429:e
      //add peiouya [MultiUPS] [UPS_Manage_Function] 20150528:e
      OB_GET_MASTER_UPDATE_SERVER_INFO_LIST,
      OB_GET_MASTER_UPDATE_SERVER_INFO_LIST_RESPONSE,
      //add 20150528:e

        //[492]
        OB_FORCE_GET_SYS_TABLE_UPDATE_SERVER_INFO_LIST,
        OB_FORCE_GET_SYS_TABLE_UPDATE_SERVER_INFO_LIST_RESPONSE,
      ...
      //add for [import:multi rs ip]-b
      OB_CHECK_IS_MASTER_RS = 12013,
      OB_CHECK_IS_MASTER_RS_RESPONSE = 12014,
      //add for [import:multi rs ip]-e
      ...
      OB_FETCH_RANGE_COLLECTION_LIST = 12028,
      OB_FETCH_RANGE_COLLECTION_LIST_RESPONSE = 12029,
      OB_STOP_GATHER_OPERATION = 12030,
      OB_STOP_GATHER_OPERATION_RESPONSE = 12031,
      //add for [statistics info]-e

      // Tenant backup/restore packet codes
      OB_TENANT_BACKUP_START = 13000,
      OB_TENANT_BACKUP_START_RESPONSE = 13001,
      OB_TENANT_BACKUP_STATUS = 13002,
      OB_TENANT_BACKUP_STATUS_RESPONSE = 13003,
      OB_TENANT_INCREMENTAL_BACKUP_START = 13004,
      OB_TENANT_INCREMENTAL_BACKUP_START_RESPONSE = 13005,
      OB_TENANT_INCREMENTAL_BACKUP_STOP = 13006,
      OB_TENANT_INCREMENTAL_BACKUP_STOP_RESPONSE = 13007,
      OB_TENANT_RESTORE_START = 13008,
      OB_TENANT_RESTORE_START_RESPONSE = 13009,
      OB_TENANT_RESTORE_STATUS = 13010,
      OB_TENANT_RESTORE_STATUS_RESPONSE = 13011,
      OB_TENANT_PROMOTE_STANDBY = 13012,
      OB_TENANT_PROMOTE_STANDBY_RESPONSE = 13013,
      OB_TENANT_DECOMMISSION = 13014,
      OB_TENANT_DECOMMISSION_RESPONSE = 13015,
      OB_TENANT_BACKUP_TABLET = 13016,
      OB_TENANT_BACKUP_TABLET_RESPONSE = 13017,
    ...
    class ObPacket
    {
      ...
      public:
        ...
        /**
         * encode yynet header, obpacket header, record header,
        ...
        static uint64_t &tsi_req_sign()
        {
          ...
          if (first_invoke)
          {
            YYSYS_LOG(INFO, "[TSI_REQ_SIGN] %p", &req_sign);
            first_invoke = false;
          }
          return req_sign;
        };
        ...
        bool* get_mutex_flag()
        { return &(lock_wait_para_.mutex_); }
        bool* get_need_response()
        { return &(lock_wait_para_.need_response_); }
        //add hongchen [LOCK_WAIT_TIMEOUT] 20161209:e

        //[616]
        void reset_lock_wait_para()
        {
            lock_wait_para_.lock_wait_timeout_ = 3000000; //3s
            lock_wait_para_.last_conflict_lock_time_ = 0;
            lock_wait_para_.need_response_ = true;
            lock_wait_para_.mutex_ = false;
        }

        //[648]
        inline void set_cleanup(){cleanup_=true;}
        inline bool is_cleanup(){return cleanup_;}

        //[701]
        int32_t get_conn_seq(){return conn_seq_;};
        void set_conn_seq(int32_t v){conn_seq_=v;};
        int64_t get_disconn_time(){return disconn_time_;};
        void set_disconn_time(int64_t v){disconn_time_=v;};
      ...
      private:
        ...
        uint32_t chid_;         //yynet header channel id
        int pcode_;             //yynet header packet code
        int packet_len_;          //yynet header total packet len not include yynet header
        ...
        ObPacket* _next;         //yynet::Packet* _next  ObPacketQueue using _next;
        int64_t expire_time_;    //compatible with yynet packet int64_t _expireTime;
        bool alloc_inner_mem_; // alloc from out_mem_pool_ or not
        bool cleanup_;         //[648]
        uint64_t trace_id_;
        uint64_t req_sign_;
        //TraceId trace_id_;
        uint32_t conn_seq_; //[701]
        int64_t disconn_time_; //[701]
