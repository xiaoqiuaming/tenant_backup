...
namespace common
{
  namespace nb_accessor
  {
    ...
    public:
      ...
      int scan(QueryRes*& res, const char* table_name, const ObNewRange& range, const SC& select_columns, const ScanConds &scan_conds, const char *groupby_column); //[index bulid clusters on/offline]
