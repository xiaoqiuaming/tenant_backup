...
namespace oceanbase
{
  namespace common
  {
    int ObRowkeyHelper::prepare_obj_array(const ObRowkeyInfo& info, ObObj* array, const int64_t size)
    {
      ...
      {
        YYSYS_LOG(WARN, "invalid argument arry = %p, size=%ld, info size=%ld",
    ...
    int ObRowkeyHelper::get_row_key(const ObObj* array, const int64_t size, ObString& key)
    {
      ...
      if (NULL == array)
      {
        YYSYS_LOG(WARN, "invalid argument arry = %p", array);
        ret = OB_ERROR;
      }
      else
      {
        ...
        for (int32_t index = 0; OB_SUCCESS == ret && index < size; ++index)
        {
          ...
          if (OB_SUCCESS != ret)
          {
            YYSYS_LOG(ERROR, "serialize_obj failed, buffer=%p, buf_len=%ld, pos=%ld",
                      buffer, buf_len, pos);
          }
        }
    ...
    int ObRowkeyHelper::get_obj_array(const ObString& key, ObObj* array, const int64_t size)
    {
      ...
      if (NULL == array)
      {
        YYSYS_LOG(WARN, "invalid argument array=%p", array);
        ret = OB_ERROR;
      }
      else
      {
        ...
        for (int32_t index = 0; OB_SUCCESS == ret && index < size; ++index)
        {
          ...
          if (pos + len > buf_len)
          {
            YYSYS_LOG(ERROR, "pos=%ld, current column=%d > buf_len=%ld",
                      pos, len, buf_len);
            ret = OB_SIZE_OVERFLOW;
          }
          else if ( OB_SUCCESS != (ret = deserialize_obj(obj, buffer, buf_len, pos)) )
          {
            YYSYS_LOG(ERROR, "deserialize_obj failed, buffer=%p, buf_len=%ld, pos=%ld",
                      buffer, buf_len, pos);
          }
        }
      }
    ...
    int ObRowkeyHelper::serialize_obj(const ObObj* obj, char* buf, const int64_t buf_len, int64_t& pos)
    {
      ...
      switch (type)
      {
        case ObIntType:
        {
          ...
          if (OB_SUCCESS == ret)
          {
            ...
            switch (length)
            {
              case 1:
              {
                ...
                if (OB_SUCCESS != ret)
                {
                  YYSYS_LOG(WARN, "serialization failed buf=%p, buf_len=%ld, pos=%ld", buf, buf_len, pos);
                }
                break;
              }
              case 2:
              ...
              default:
                YYSYS_LOG(WARN, "unsupport serialization length");
          ...
          {
            YYSYS_LOG(WARN, "Get int value failed");
          }
          break;
        }
        ...
        case ObInt32Type:
        {
          ...
          {
            YYSYS_LOG(WARN, "Get int32 value failed");
          }
          break;
        }
          //add 20151008:e
        case ObVarcharType:
        {
          ...
          {
            YYSYS_LOG(WARN, "Get varchar value failed");
          }
          break;
        }
        case ObDateTimeType:
        {
          ...
          {
            YYSYS_LOG(WARN, "Get datatime value failed");
          }
          break;
        }
        ...
        case ObDateType:
        {
          ...
          {
            YYSYS_LOG(WARN, "Get date time value failed");
          }
          break;
        }
        case ObTimeType:
        ...
        case ObModifyTimeType:
        {
          ...
          {
            YYSYS_LOG(WARN, "Get modify time value failed");
          }
          break;
        }
        case ObCreateTimeType:
        {
          ...
          {
            YYSYS_LOG(WARN, "Get create time value failed");
          }
          break;
        }
        default:
          YYSYS_LOG(ERROR, "invalid obj_type=%d, rowkey does not support", type);
          ret = OB_ERR_UNEXPECTED;
          break;
      }
      return ret;
    ...
    int ObRowkeyHelper::deserialize_obj(ObObj* obj, const char* buf, const int64_t buf_len, int64_t& pos)
    {
      ...
      switch (type)
      {
        case ObIntType:
        {
          ...
          switch (length)
          {
            case 1:
            {
              ...
              {
                YYSYS_LOG(WARN, "deserialization failed buf=%p, buf_len=%ld, pos=%ld", buf, buf_len, pos);
              }
              break;
            }
            case 2:
            ...
            default:
              YYSYS_LOG(WARN, "unsuported deserialize length");
              ret = OB_ERR_UNEXPECTED;
              break;
          }
          if (OB_SUCCESS == ret)
        ...
        case ObDateTimeType:
        {
          ...
          {
            YYSYS_LOG(WARN, "deserialize failed buf=%p, buf_len=%ld, pos=%ld", buf, buf_len, pos);
          }
          break;
        }
          //add peiouya [DATE_TIME] 20150906:b
                                                   ...
                                                   const ObString& binary_key, ObObj* array, const int64_t size)
    {
      ...
      {
        YYSYS_LOG(WARN, "invalid argument array = %p, size=%ld, info size=%ld",
                  array, size, info.get_size());
        ret = OB_ERROR;
      }
      else
      {
        ...
        for (int64_t index = 0; index < info.get_size() && OB_SUCCESS == ret; ++index)
        {
          ...
          if (OB_SUCCESS == ret)
          {
            ...
            {
              YYSYS_LOG(ERROR, "pos=%ld, current column=%d > column length=%ld, rowkey_info:%s",
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        for (int64_t index = 0; index < info.get_size() && OB_SUCCESS == ret; ++index)
        {
          ...
          if (OB_SUCCESS == ret)
          {
            ...
            if (OB_SUCCESS != ret)
            {
              YYSYS_LOG(WARN, "serialize_obj failed, buffer=%p, buf_len=%ld, pos=%ld",
                        buffer, buf_len, pos);
            }
          }
        }
