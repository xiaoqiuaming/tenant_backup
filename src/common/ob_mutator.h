...
namespace oceanbase
{
  namespace common
  {
    ...
    // ʹ��mutator����ע�� ��mutator�е������� ���뱣֤�����˷����л�����������ȡis_row_changed��is_row_finished��� ����᷵��not support
    class ObMutator
    {
      ...
      public:
        ...
        enum BarrierFlag // Bit Flag
        {
          ...
          ROWKEY_BARRIER = 1,
          ROW_DML_TYPE = 0x2,
          STATEMENT_BARRIER = 0x4, //add by maosy [MultiUps 1.0] [secondary index optimize] 20170722 b:
        };
      ...
      public:
        ...
        void rollback()
        {
          ...
          YYSYS_TRACE_LOG("rollback list_head=%p list_tail=%p cell_count=%ld cell_store_size=%ld", list_head_, list_tail_, cell_count_, cell_store_size_);
        };
      public:
        ...
        //add:e
        int add_stat_barrier(); //add by maosy [MultiUps 1.0] [secondary index optimize] 20170722 b:
        int add_row_barrier();
      ...
      public:
        ...
        void get_curr_node_dmltype(ObDmlType &dml_type)
        {
      ...
      private:
        ...
        MUTATOR_TYPE type_;
        bool has_begin_;
        bool is_stat_end_;  //add by maosy [MultiUps 1.0] [secondary index optimize] 20170722 b:
