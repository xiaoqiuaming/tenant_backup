  ...
  namespace common
  {
    class ObRowFuse
    {
      ...
      public:
        ...
        static int get_is_complete_row(const common::ObRow *& row, bool& is_complete_row, bool& is_empty_row);
        static int get_is_complete_row_in_cell_level(const common::ObRow *& row, bool& is_complete_row);
        //add 20160425:e
      private:
