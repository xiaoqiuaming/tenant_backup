  ...
  namespace common
  {
    ...
    class ObExtraTablesSchema
    {
      ...
      public:
        ...
        //add 20150324:e
        static int all_partition_rules(TableSchema &table_schema);
        static int all_table_rules(TableSchema &table_schema);
        static int all_all_group(TableSchema &table_schema);
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150701:b
        static int ups_session_info_schema(TableSchema& table_schema);
        //add 20150701:e
        //add liuzy [MultiUPS] [take_cluster_offline_interface] 20160325:b
        static int all_cluster_stat_info_schema(TableSchema &table_schema);
        //add 20160325:e
        //add for [513-delete cluster paxos]-b
        static int all_change_cluster_paxos_schema(TableSchema &table_schema);
        //add for [513-delete cluster paxos]-e
        //add for [statistics build]-b
        static int all_udi_monitor_list(TableSchema &table_schema);
        ...
        //[view]
        static int all_view_schema(TableSchema &table_schema);
      private:
        ObExtraTablesSchema();
    };
