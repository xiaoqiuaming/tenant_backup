...
#define ADD_MOD(mod_name)\
  ...
  {\
    ...
    {\
      ...
      OB_MOD_SET[ObModIds::mod_name].inited_ = true;\
    }\
  }while (0)
    ...
    class ObModIds
    {
      public:
        enum
        {
          ...
          //add liu jun. [MultiUPS] [part_cache] 20150609:b
          OB_PARTITION_MANAGER,
          //add:e
          //add lijianqiang [MultiUPS] [MERGE] 20151210:b
          OB_MULTI_UPS_SCAN,//for daily merge
          OB_MULTI_UPS_PHY_SCAN,//for select SCAN
          OB_MULTI_UPS_PHY_GET,//for select GET
          //add 20151210:e
          ...
          OB_MS_SUB_QUERY,
          //add 20140606:e
          //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160107:b
          OB_READ_ATOMIC,
          OB_READ_ATOMIC_ITER,
          OB_READ_ATOMIC_RPC_SCAN,
          //add duyr 20160107:e
          ...
          OB_LOAD_DATA_INFO,
          OB_RS_UPS_MANAGER,//add liuzy [MultiUPS] [UPS_Manager] 20151211
          ...
          OB_SQL_PHYSICAL_PLAN_ROW_STORE,  //add shili [MultiUPS] [PHYSICAL_PLAN_TRANSFORM] 20150705
    ...
    inline void init_ob_mod_set()
    {
      ...
      //add liu jun. [MultiUPS] [part_cache] 20150609:b
      ADD_MOD(OB_PARTITION_MANAGER);
      //add:e
      //add lijianqiang [MultiUPS] [MERGE] 20151210:b
      ADD_MOD(OB_MULTI_UPS_SCAN);
      ADD_MOD(OB_MULTI_UPS_PHY_SCAN);
      ADD_MOD(OB_MULTI_UPS_PHY_GET);
      //add 20151210:e
      ...
      //add 20140606:e
      //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160107:b
      ADD_MOD(OB_READ_ATOMIC);
      ADD_MOD(OB_READ_ATOMIC_ITER);
      ADD_MOD(OB_READ_ATOMIC_RPC_SCAN);
      //add duyr 20160107:e
      ...
      //add wanglei [semi join] 20160614:e
      ADD_MOD(OB_SEMI_JOIN_LEFT_CACHE);
      ADD_MOD(OB_SEMI_JOIN_RIGHT_CACHE);
      ADD_MOD(OB_STATISTICS_BUILD);
      ADD_MOD(OB_TABLET_STATISTIC_HISTOGRAM_REPORT);
      ADD_MOD(OB_QUERY_OPT);
      ...
      ADD_MOD(OB_UPS_REPLAY_LOG_TASK);
      ...
      ADD_MOD(OB_SQL_PHYSICAL_PLAN_ROW_STORE);//add shili [MUTIUPS] [MERGE] 20150705
