  ...
  namespace common
  {
    ...
    class S2MQueueThread
    {
      ...
      public:
        ...
        int64_t get_high_prio_queued_num()
        { return high_prio_queued_num_; }
        int64_t get_normal_prio_queued_num()
        { return normal_prio_queued_num_; }
        int64_t get_hotspot_queued_num()
        { return hotspot_queued_num_; }
        int64_t get_low_prio_queued_num()
        { return low_prio_queued_num_; }
