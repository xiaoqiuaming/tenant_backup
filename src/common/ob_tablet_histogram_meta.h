  ...
  namespace common
  {
    ...
    class ObTabletHistogramTable
    {
      ...
      public:
        ...
        /*
         * ��hist����ObTabletHistogramManager��, �õ�histogram_index_,
         * ����ObHistogramMeta, ���ӵ�meta_table_��
         */
        //don't use this func
        //int add_hist_meta(const ObTabletInfo &tablet_info, const ObTabletHistogram &hist, const int32_t server_index);

        /*
         * hist�Ѿ�����ObTabletHistogramManager��, �Ѿ��õ�����hist_manager��hist_index, ֻ��Ҫ����ObHistogramMeta, ���ӵ�meta_table_��
         * ��Ϊдhist tableʱ��Ҫ����, ��add_histogram()��add_hist_meta()�ֿ�, ����������
         */
        ...
        int add_hist_meta(const ObTabletInfo &tablet_info, const int32_t hist_index, const int32_t server_index, const uint64_t idx_tid, bool &is_repeat_report);
