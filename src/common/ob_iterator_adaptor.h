  ...
  namespace common
  {
    class ObObjCastHelper
    {
      ...
      public:
        ...
        int64_t get_col_len(int64_t idx);
        uint32_t get_col_type(int64_t idx);
      public:
      ...
      private:
        ...
        int64_t col_num_;
        int64_t col_lens_[OB_ROW_MAX_COLUMNS_COUNT];
    };
    ...
    class ObCellAdaptor : public ObIterator
    {
      ...
      private:
        ...
        ObStringBuf str_buf_; //[update decimal secondary index bugfix]
    };
    ...
    class ObRowIterAdaptor : public sql::ObRowkeyPhyOperator
    {
      ...
      public:
        int open();
        int close();
        virtual sql::ObPhyOperatorType get_type() const
        { return sql::PHY_ROW_ITER_ADAPTOR; }
