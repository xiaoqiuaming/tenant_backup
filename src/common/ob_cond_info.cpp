...
DEFINE_SERIALIZE(ObCondInfo)
{
  ...
  if (OB_SUCCESS != ret)
  {
    YYSYS_LOG(WARN, "serialize op type failed:type[%d], ret[%d]", op_type_, ret);
  }
  else if (OB_INVALID_ID != cell_.table_id_)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "serialize talbe id failed:table_id[%lu], ret[%d]", cell_.table_id_, ret);
    }
    else
    {
      ...
      if (OB_SUCCESS != ret)
      {
        YYSYS_LOG(WARN, "serialize column id failed:column_id[%lu], ret[%d]",
  ...
  else
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "serialize talbe name failed:table_name[%.*s], ret[%d]",
    ...
    { 
      ...
      if (OB_SUCCESS != ret)
      {
        YYSYS_LOG(WARN, "serialize column name failed:column_name[%.*s], ret[%d]",
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "serialize rowkey failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "serialize cell value failed:ret[%d]", ret);
    }
  }
  return ret;
}
...
DEFINE_DESERIALIZE(ObCondInfo)
{
  ...
  if (OB_SUCCESS != ret)
  {
    YYSYS_LOG(WARN, "deserialize op type failed:ret[%d]", ret);
  }
  else if (ObIntType == obj.get_type())
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(WARN, "get op type int value failed:ret[%d]", ret);
    }
    else
    {
  ...
  {
    ret = OB_ERROR;
    YYSYS_LOG(WARN, "check op type obj type failed:type[%d]", obj.get_type());
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(WARN, "deserialize table failed:ret[%d]", ret);
    }
    else if (ObIntType == obj.get_type())
    {
      ...
      if (ret != OB_SUCCESS)
      {
        YYSYS_LOG(WARN, "check get int table id failed:ret[%d]", ret);
      }
      else if (OB_SUCCESS != (ret = obj.deserialize(buf, data_len, pos)))
      {
        YYSYS_LOG(WARN, "deserialize column id failed:table_id[%lu], ret[%d]",
            cell_.table_id_, ret);
      }
      else if (OB_SUCCESS != (ret = obj.get_int((int64_t &)cell_.column_id_)))
      {
        YYSYS_LOG(WARN, "check get int column id failed:table_id[%lu], ret[%d]",
            cell_.table_id_, ret);
      }
    }
    else
    {
      ...
      if (ret != OB_SUCCESS)
      {
        YYSYS_LOG(WARN, "check get varchar table name failed:ret[%d]", ret);
      }
      else if (OB_SUCCESS != (ret = obj.deserialize(buf, data_len, pos)))
      {
        YYSYS_LOG(WARN, "deserialize column name failed:table_name[%.*s], ret[%d]",
            cell_.table_name_.length(), cell_.table_name_.ptr(), ret);
      }
      else if (OB_SUCCESS != (ret = obj.get_varchar(cell_.column_name_)))
      {
        YYSYS_LOG(WARN, "check get varchar column name failed:table_name[%.*s], ret[%d]",
            cell_.table_name_.length(), cell_.table_name_.ptr(), ret);
      }
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    {
      YYSYS_LOG(WARN, "deserialize rowkey failed:ret[%d]", ret);
    }
    else if (is_binary_rowkey && NULL == rowkey_info_)
    {
      YYSYS_LOG(WARN, "have not set rowkey_info cannot deserialize rowkey of string type");
    }
    else
    {
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(WARN, "deserialize cond value failed:ret[%d]", ret);
    }
  }
  return ret;
}
...
int ObCondInfo::deep_copy(ObCondInfo & dest, ObStringBuf & buffer) const
{
  ...
  else
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(WARN, "write string for table name failed:ret[%d]", ret);
    }
    else if (OB_SUCCESS != (ret = buffer.write_string(cell_.column_name_, &dest.cell_.column_name_)))
    {
      YYSYS_LOG(WARN, "write string for column name failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(WARN, "write string for row key failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(WARN, "write obj for value failed:ret[%d]", ret);
    }
  }
  return ret;
}
