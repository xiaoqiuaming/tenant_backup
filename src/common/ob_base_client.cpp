...
int ObBaseClient::initialize(const ObServer& server)
{
  ...
  else
  {
    ...
    client_handler_.on_connect = ObTbnetCallback::on_connect;
    client_handler_.cleanup = ObTbnetCallback::clean_up;
