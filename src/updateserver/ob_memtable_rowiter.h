  ...
  namespace updateserver
  {
    ...
    class MemTableRowIterator : public IRowIterator, public RowkeyInfoCache
    {
      ...
      public:
        ...
        virtual int get_row(sstable::ObSSTableRow &sstable_row, const CommonSchemaManager *sm = NULL);
        virtual int reset_iter();
        virtual bool get_compressor_name(common::ObString &compressor_str);
        virtual bool get_sstable_schema(sstable::ObSSTableSchema &sstable_schema, const CommonSchemaManager *sm = NULL);
        virtual const common::ObRowkeyInfo *get_rowkey_info(const uint64_t table_id, const CommonSchemaManager *sm = NULL) const;
      ...
      private:
        ...
        int set_table_iter_(int64_t table_id); // add zhaoqiong [306 bugfix]
