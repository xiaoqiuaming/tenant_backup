...
//      YYSYS_LOG(DEBUG, "slave renew keep alive msg. cur_time = %ld, last_keep_alive_time=%ld", cur_time_us, last_keep_alive_time_);
...
//      {
//        YYSYS_LOG(DEBUG, "start to check inner keep alive msg");
//        renew_keep_alive_time();
//      }
//      else
//      {
//        YYSYS_LOG(DEBUG, "stop to check inner keep alive msg");
//      }
...
//    void ObUpsKeepAlive::run(yysys::CThread* thread, void* arg)
//    {
//      UNUSED(thread);
//      UNUSED(arg);
...
//          if (OB_SUCCESS != err)
//          {
//            YYSYS_LOG(WARN, "fail to grant keep alive to slave, err = %d", err);
//          }
//        }
...
//          {
//            YYSYS_LOG(WARN, "keep_alive msg timeout, last_time = %ld, cur_time = %ld, duration_time = %ld", last_keep_alive_time_,
//                cur_time_us, keep_alive_timeout_);
//            role_mgr_->set_state(ObRoleMgr::INIT);
//          }
//          else
//          {
//            YYSYS_LOG(DEBUG, "keep alive, last_time = %ld, cur_time = %ld, duration_time = %ld", last_keep_alive_time_,
//                cur_time_us, keep_alive_timeout_);
//          }
//        }
//        else
//        {
//          YYSYS_LOG(DEBUG, "not ready to deal with keep_alive msg");
//        }
//        count ++;
