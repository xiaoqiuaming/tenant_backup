  ...
  namespace updateserver
  {
    ...
    class ObLogBuffer : public ObRingDataBuffer
    {
      public:
        ...
        int append_log(const int64_t start_id, const int64_t end_id, const char* buf, const int64_t len, bool &is_append);
    ...
    // 可能返回OB_DATA_NOT_SERVE
    int get_from_log_buffer_2(ObLogBuffer* log_buf,
                              const int64_t align_bits,
                              const int64_t advised_pos,
                              int64_t& real_pos,
                              const int64_t start_id,
    ...
    int append_to_log_buffer_2(ObLogBuffer* log_buf, const int64_t start_id, const int64_t end_id,
                             const char* buf, const int64_t len, bool &is_append);
