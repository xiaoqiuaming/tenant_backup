...
namespace oceanbase
{
  ...
  {
    class StressRunnable: public yysys::CDefaultRunnable
    {
      public:
        ...
        virtual void run(yysys::CThread* thread, void* arg)
        {
          ...
          ObPacket pkt;
          UNUSED(thread);
          YYSYS_LOG(INFO, "StressRunnable.start(arg=%ld)", (int64_t)arg);
          ...
          YYSYS_LOG(INFO, "StressRunnable.stop(arg=%ld)=>%d", (int64_t)arg, err);
        }
