...
//        YYSYS_LOG(ERROR, "invalid argumeng, obi_role =%p", obi_role);
//      }
//      else
//      {
//        uint32_t vip = 0;
...
//      {
//        err = OB_INVALID_ARGUMENT;
//        YYSYS_LOG(ERROR, "invalid argument. master add=%p", master);
//      }
//      else
//      {
//        server_ = master;
...
//      UNUSED(arg);
//      int err = OB_SUCCESS;
//      YYSYS_LOG(INFO, "start to check ups inner lease");
...
//              {
//                YYSYS_LOG(ERROR, "ups slave invalid lease, set server to INIT state");
...
//                    && OB_NOT_MASTER == err)
//                {
//                  YYSYS_LOG(INFO,  "master inst has changed the master ups.");
//                  ups_main->get_update_server().set_ups_inner_lease_fail();
//                  role_mgr_->set_state(ObRoleMgr::INIT);
...
//                if (OB_SUCCESS != err)
//                {
//                  YYSYS_LOG(WARN, "fail to renew lease. err=%d", err);
//                }
//              }
//            }
//          }
