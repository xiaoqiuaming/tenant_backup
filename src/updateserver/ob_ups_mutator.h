  ...
  namespace updateserver
  {
    ...
    class ObUpsMutator
    {
      ...
      public:
        ...
        int set_trun_flag(); //add zhaoqiong [truncate table]

        bool is_normal_mutator() const;

        bool is_truncate_mutator() const;//add zhaoqiong [truncate table]
      ...
      private:
        ...
        static const int32_t TRUN_FLAG = 6;//add zhaoqiong [truncate table]
    ...
    //used for participant write commit log and replay check checksum
    struct PartCommitInfo
    {
      PartCommitInfo();
      int serialize(char* buf, const int64_t buf_len, int64_t& pos) const;
      int deserialize(const char* buf, const int64_t buf_len, int64_t& pos);
