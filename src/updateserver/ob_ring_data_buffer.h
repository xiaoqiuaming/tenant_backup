...
namespace oceanbase
{
  namespace updateserver
  {
    ...
    class ObRingDataBuffer
    {
      ...
      static const int64_t DEFAULT_N_BLOCKS = 32;
      ...
      public:
        ...
        int append(const char *buf, const int64_t len, bool &is_append);//add [async load log]
      public:
        ...
        int64_t get_replay_pos() const;//add [async load log]
        void set_replay_pos(int64_t read_pos, int64_t read_count);//add [async load log]
        bool is_can_append() const;//add [async load log]
        int64_t get_use_blocks();//add [async load log]
      ...
      protected:
        ...
        volatile int64_t replay_pos_;//add [async load log]
    };
