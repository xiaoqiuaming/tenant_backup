...
#include "common/skiplist.h"//add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150701
    ...
    class BaseSessionCtx
    {
      ...
      public:
        ...
        virtual void reset()
        {
          ...
          last_proc_time_ = 0;
          //add hongchen [LOCK_WAIT_TIMEOUT] 20161209:b
          mutex_flag_for_pkt_ptr_ = false;
          pkt_ptr_ = NULL;
          //add hongchen [LOCK_WAIT_TIMEOUT] 20161209:e
          // del by maosy [Delete_Update_Function_isolation_RC] 20161218
          start_time_for_batch_ = common::OB_INVALID_DATA;
          has_mark_stmt_ = false;
          // del e
          can_be_killed_ = true;
        };
        virtual void kill()
        ...
        //add 20150701:e
        //add duyr [MultiUPS] [READ_ATOMIC] [write_part] 20151117:b
        virtual const common::ObTransID& get_coordinator_info()
        {
          YYSYS_LOG(ERROR,"should not be here!");
          return invalid_trans_id_;
        }
        //add duyr 20151117:e
      ...
      public:
        ...
        {
          return (yysys::CTimeUtil::getTime() - start_handle_time_) > slow_query_time_limit;
        };
        int64_t get_session_timeu() const
        {
          return yysys::CTimeUtil::getTime() - session_start_time_;
        };
        ...
        bool is_session_expired() const
        {
          ...
          if (bret)
          {
            YYSYS_LOG(WARN, "session expired, sd=%u ctx=%p cur_time=%ld "
        ...
        //add hongchen [LOCK_WAIT_TIMEOUT] 20161209:b
        bool* get_mutex_flag_for_pkt_ptr()
        {return &mutex_flag_for_pkt_ptr_;}
        ...
        int64_t get_lock_wait_time() const
        { return pkt_ptr_!= NULL ? yysys::CTimeUtil::getTime()- pkt_ptr_->get_last_conflict_lock_time() : 0; }
        //add:e
        // del by maosy [Delete_Update_Function_isolation_RC] 20161218
...
// add by maosy [Delete_Update_Function_isolation_RC] 20161228
        ...
        {
            start_time_for_batch_= trans_id ;
            YYSYS_LOG(DEBUG,"start_time_for_batch_=%ld",start_time_for_batch_);
        }
        ...
        void set_has_mark_stmt(bool mark_stmt)
        {
            has_mark_stmt_ = mark_stmt ;
        }
        bool get_has_mark_stmt()
        {
            return has_mark_stmt_;
        }
//add e
        void set_can_be_killed(bool stat)
        {
            can_be_killed_ = stat;
        }
        bool get_can_be_killed()
        {
            return can_be_killed_;
        }
      ...
      private:
        ...
        //add duyr [MultiUPS] [READ_ATOMIC] [write_part] 20151117:b
        const common::ObTransID invalid_trans_id_;
        //add duyr 20151117:e
        //add hongchen [LOCK_WAIT_TIMEOUT] 20161209:b
        bool    mutex_flag_for_pkt_ptr_;
    ...
    class SessionMgr : public yysys::CDefaultRunnable
    {
      ...
      public:
        ...
        //[521]
        enum kill_session_state
        {
            //normal stat
            KS_NORMAL = 0,
            //start process unsettled queue
            KS_PROCESS = 1,
        };
      ...
      public:
        ...
        int begin_session(const SessionType type,
                          const int64_t start_time,
                          const int64_t timeout,
                          const int64_t idle_time,
                          uint32_t &session_descriptor,
                          const common::PacketCode pcode = common::OB_PACKET_NUM);
        //mod 20150811:e
        ...
        void lock_write_session_for_sync_freeze();
        void unlock_write_session_for_sync_freeze();
        //add 20150811:e
        ...
        int64_t get_flying_rosession_num() const
        {return ctx_list_[ST_READ_ONLY].get_free();};
        int64_t get_flying_rpsession_num() const
        {return ctx_list_[ST_REPLAY].get_free();};
        int64_t get_flying_rwsession_num() const
        {return ctx_list_[ST_READ_WRITE].get_free();};
        IncSeq& get_trans_seq()
        { return trans_seq_; }
        void enable_start_write_session()
        { allow_start_write_session_ = true; }
        void disable_start_write_session()
        { allow_start_write_session_ = false; }
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150701:b
        int add_unsettled_trans(common::ObTransID& trans_id);
        common::SkipList<common::ObTransID>& get_unsettled_trans();
        //add:e
        void switch_ks_state(kill_session_state stat);//[521]
        int check();//[521]
		 //add hongchen [LOCK_WAIT_TIMEOUT] 20161209:b
      public:
      ...
      private:
        ...
        //add peiouya [MultiUPS] [UPS_SYNC_Frozen] 20150810:b
        //this variable only use for UPS_SYNC_Frozen.
        bool is_session_lock_for_sync_frozen_;
        //add 20150810:e
        bool allow_start_write_session_;
        //add peiouya [MultiUPS] [DISTRIBUTED_TRANS] 20150701:b
        volatile uint64_t unsettled_trans_lock_;
        common::SkipList<common::ObTransID> unsettled_transaction_;
        //add 20150701:e
        volatile kill_session_state ks_stat_;//[521]
    };
