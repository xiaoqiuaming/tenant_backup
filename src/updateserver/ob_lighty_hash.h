    ...
    namespace lightyhash
    {
      ...
      class LightyHashMap
      {
        ...
        public:
          ...
          inline int update_value(const Key &key, const Value &value);
      ...
      template <typename Key, typename Value, typename BucketAllocator, typename NodeAllocator>
      int LightyHashMap<Key, Value, BucketAllocator, NodeAllocator>::update_value(const Key &key, const Value &value)
      {
