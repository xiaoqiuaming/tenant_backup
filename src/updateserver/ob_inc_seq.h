    ...
    class RefCnt
    {
      ...
      public:
                   ...
                   thread_num_(0)
        {
          ...
          int tmp_ret = common::PTHREAD_KEY_MGR->create_thread_key(key_);
        ...
        ~RefCnt()
        {
          ...
          common::PTHREAD_KEY_MGR->delete_thread_key(key_);
          //mod hongchen [TSD_USER_IMPL] 20170916:e
        };
      public:
        void born()
        ...
        void ref()
        {
          ...
          volatile RefNode* ref_node = (volatile RefNode*)(common::PTHREAD_KEY_MGR->get_thread_specifi(key_));
          if (NULL == ref_node)
          {
            ref_node = &ref_nodes_[__sync_fetch_and_add(&thread_num_, 1) % N_THREAD];
            //int tmp_ret = pthread_setspecific(key_, (void*)ref_node);
            int tmp_ret = common::PTHREAD_KEY_MGR->set_thread_specifi(key_, (void*)ref_node);
            if (0 != tmp_ret)
            {
          ...
          if (end_flag_)
          {
            YYSYS_LOG(ERROR, "unexpected error, end_flag must not be true");
          }
        ...
        bool deref()
        {
          ...
          if (NULL == ref_node)
          {
            ...
            YYSYS_LOG(INFO, "deref when ref_node=NULL, maybe anothor thread call ref");
          }
          //mod hongchen [TSD_USER_IMPL] 20170916:e
          if (NULL != ref_node)
          {
      ...
      private:
        ...
        common::itemkey key_                  CACHE_ALIGNED;
        //mod hongchen [TSD_USER_IMPL] 20170916:e
