  ...
  namespace updateserver
  {
    ...
    class QueryEngine
    {
      ...
      public:
        ...
        int update_tevalue_keybtree_and_keyhash(const TEKey &key, TEValue *value); //add peiouya [bug fix secondary index opti when rollback]
    ...
    class QueryEngineIterator
    {
      ...
      public:
        ...
        inline void set_is_read_atomic(const bool val)
        {is_read_atomic_ = val;}
        //add duyr 20160121:e
      private:
