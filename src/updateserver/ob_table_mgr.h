  ...
  namespace updateserver
  {
    ...
    class ITableIterator : public common::ObIterator
    {
      public:
        ...
        virtual int64_t get_version(void) = 0;
        //add 20151228:e
    };
    ...
    class MemTableEntityIterator : public ITableIterator
    {
      ...
      public:
        ...
        virtual int64_t get_version(void);
        //add 20151228:e
    ...
    class SSTableEntityIterator : public ITableIterator
    {
      ...
      public:
        ...
        //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160423:b
        void set_data_mark(const ObReadAtomicDataMark &data_mark);
    private:
        bool is_has_read_atomic_cell();
        void reset_read_atomic_cell();
        int next_read_atomic_cell(const bool is_row_changed = false);
        //add duyr 20160423:e
      private:
        ...
        //add 20151228:e
        //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20160423:b
        //once state turn into outputing read atomic cell
        //never invode real data next cell,
        //otherwise cur interrupt state will be damaged!!!!!!
        bool has_store_real_data_state_;
        bool is_outputing_read_atomic_cell_;
        common::ObCellInfo *old_real_ci_ptr_;
        common::ObCellInfo read_atomic_cell_;
        ...
        bool is_strategy_init_;
        ReadStrategy strategy_state_;
    ...
    class ITableEntity
    {
      public:
        ...
        {
          public:
            SSTableResourcePool &get_sstable_rp()
            {return sstable_rp_;};
            MemTableResourcePool &get_memtable_rp()
            {return memtable_rp_;};
            RowIterAdaptorResourcePool &get_row_iter_adaptor_rp()
            { return row_iter_adaptor_rp_; }
          private:
        ...
        class Guard
        {
          ...
          public:
            SSTableGuard &get_sstable_guard()
            {return sstable_guard_;};
            MemTableGuard &get_memtable_guard()
            {return memtable_guard_;};
            RowIterAdaptorGuard &get_row_iter_adaptor_guard()
            {return row_iter_adaptor_guard_;};
          private:
      ...
      public:
        ...
        virtual int get_table_truncate_stat(uint64_t table_id, bool &is_truncated) = 0;
      public:
    ...
    class MemTableEntity : public ITableEntity
    {
      ...
      public:
        ...
        virtual int get_table_truncate_stat(uint64_t table_id, bool &is_truncated);
        //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20151207:b
        int fill_local_data_mark(ObReadAtomicDataMark &local_data_mark);
        //add duyr 20151207:e
      private:
        MemTable memtable_;
    };
    ...
    class SSTableEntity : public ITableEntity
    {
      ...
      public:
        ...
        virtual int get_table_truncate_stat(uint64_t table_id, bool &is_truncated); /*add zhaoqiong [Truncate Table]:20160318*/
        //add duyr [MultiUPS] [READ_ATOMIC] [read_part] 20151207:b
        int fill_local_data_mark_(ObReadAtomicDataMark &local_data_mark);
        //add duyr 20151207:e
      private:
    ...
    class TableItem
    {
      ...
      public:
        ...
        //int get_table_truncate_stat(uint64_t table_id, bool &is_truncated); /*add zhaoqiong [Truncate Table]:20160318*/
        int get_table_truncate_stat(uint64_t table_id, int tabletype, bool &is_truncated);//bugfix [226]
        MemTable &get_memtable();
        ...
        void set_last_clog_id(const uint64_t last_clog_id);
    ...
    class TableMgr : public ISSTableObserver, public IExternMemTotal
    {
      ...
      public:
        ...
        //int init();
        int init(uint64_t start_major_version = SSTableID::START_MAJOR_VERSION);
        //mod 20150521:e
        void destroy();
        ...
        int try_freeze_memtable(const int64_t mem_limit, const int64_t num_limit,
                                ...
                                bool &major_version_changed, const uint64_t limit_version = 0);
        ...
        bool need_lock_partition() const;
        //add 20150601:e
        ...
        int serialize_ups_memtable_info(SSTableMgr &sstable_mgr, char *buf, const int64_t buf_len, int64_t &pos);

        void set_memtable_attr(const MemTableAttr &memtable_attr);
        int get_memtable_attr(MemTableAttr &memtable_attr);

        void get_ups_used_mem(int64_t &mem_size);
        ...
        //[588] add
        void get_memtable_rd_lock()
        {
            memtable_lock_.rdlock();
        }
        void get_memtable_wr_lock()
        {
            memtable_lock_.wrlock();
        }
        void release_memtable_lock()
        {
            memtable_lock_.unlock();
        }
        bool check_lock()
        {
            return memtable_lock_.check_wr_lock();
        }
        bool exist_lock()
        {
            return memtable_lock_.exist_lock();
        }
      ...
      private:
        ...
        TableItem *freeze_active_(const uint64_t new_version, const uint64_t limit_version = 0);
        //mod 20150521:e
      ...
      private:
        ...
        common::SpinRWLock memtable_lock_; //[588]
    };
    ...
    class MinorFreezeDuty : public common::ObTimerTask
    {
      public:
         static const int64_t SCHEDULE_PERIOD = 1L *60L * 1000000L;
      public:
         MinorFreezeDuty()
         {};
         virtual ~MinorFreezeDuty()
         {};
         virtual void runTimerTask();
    };

    //[588]
    class MemtableLockDuty : public common::ObTimerTask
    {
    public:
        static const int64_t SCHEDULE_PERIOD = 1L * 1000000L * 30;
        enum Stat
        {
            NO_LOCK = 0,
            EXIST_LOCK = 1,
