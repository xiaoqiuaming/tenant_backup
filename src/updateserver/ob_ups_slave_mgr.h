  ...
  namespace updateserver
  {
    ...
    //mod:e
    {
      public:
        ...
        //add :e
        inline int64_t get_last_send_log_id() const
        { return last_send_log_id_; } // add lbzhong[Clog Monitor] 20151218:b:e
        ...
        //add lxb [bugfix_get_multi_logid]:20180529
        void set_my_log_seq(const int64_t my_log_seq)
        {  my_log_seq_ = my_log_seq; }
