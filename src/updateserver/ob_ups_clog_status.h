  ...
  namespace updateserver
  {
    ...
    struct ObUpsCLogStatus
    {
      ObUpsCLogStatus(): obi_slave_stat_(UNKNOWN_SLAVE), slave_sync_type_(),
                      ...
                      sys_table_master_ups_() /*add peiouya [MultiUPS] [DELETE_OBI] 20150810*/,
      ...
      //expr:add new output info(sys tables master ups info)
      common::ObServer sys_table_master_ups_;
      //mod 20150810:e
