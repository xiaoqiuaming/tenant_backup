  ...
  namespace lsync
  {
    ...
    struct ObLogSyncPoint: public ObLsyncPacket
    {
      ...
      virtual int serialize(char* buf, int64_t len, int64_t& pos)
      {
             ...
             && OB_SUCCESS == serialization::encode_i64(buf, len, pos, log_seq_id)))
        {
          ...
          YYSYS_LOG(WARN, "ObLogSyncPoint.serialize(buf=%p, len=%ld, pos=%ld)=>%d", buf, len, pos, rc);
        }
        return rc;
      }
      ...
      virtual int deserialize(char* buf, int64_t len, int64_t& pos)
      {
              ...
              && OB_SUCCESS == serialization::decode_i64(buf, len, pos, (int64_t*)&log_seq_id)))
        {
          ...
          YYSYS_LOG(WARN, "YaoLogSyncPoint.deserialize(buf=%p, len=%ld, pos=%ld)=>%d", buf, len, pos, rc);
        }
        return rc;
      }
      virtual char* str(char* buf, int len)
      {
        snprintf(buf, len, "YaoLogSyncPoint{log_file_id=%ld, log_seq_id=%ld}", log_file_id, log_seq_id);
        return buf;
      }
    };
    ...
    struct ObSlaveRegisterResponse: public ObLsyncPacket
    {
      ...
      virtual int serialize(char* buf, int64_t len, int64_t& pos)
      {
        ...
        {
          rc = OB_SERIALIZE_ERROR;
          YYSYS_LOG(WARN, "ObSlaveRegisterResponse.serialize(buf=%p, len=%ld, pos=%ld)=>%d", buf, len, pos, rc);
        }
        return rc;
      }
      ...
      virtual int deserialize(char* buf, int64_t len, int64_t& pos)
      {
        ...
        {
          YYSYS_LOG(WARN, "ObSlaveRegisterResponse.deserialize(buf=%p, len=%ld, pos=%ld)=>%d", buf, len, pos, rc);
          rc = OB_DESERIALIZE_ERROR;
        }
        return rc;
      }
      ...
      virtual char* str(char* buf, int len)
      {
        ...
        snprintf(buf, len, "YaoSlaveRegisterResponse{err=%d, sync_point=%s}", result_code.result_code_, sync_point_buf);
        return buf;
      }
    };
    ...
    struct ObFetchLogResponse: public ObLsyncPacket
    {
      ...
      virtual int serialize(char* buf, int64_t len, int64_t& pos)
      {
        ...
        {
          rc = OB_SERIALIZE_ERROR;
          YYSYS_LOG(WARN, "ObFetchLogResponse.serialize(buf=%p, len=%ld, pos=%ld)=>%d", buf, len, pos, rc);
        }
        return rc;
      }
      ...
      virtual int deserialize(char* buf, int64_t len, int64_t& pos)
      {
        ...
        {
          YYSYS_LOG(WARN, "YaoFetchLogResponse.deserialize(buf=%p, len=%ld, pos=%ld)=>%d", buf, len, pos, rc);
          rc = OB_DESERIALIZE_ERROR;
        }
        return rc;
      }
      ...
      virtual char* str(char* buf, int len)
      {
        snprintf(buf, len, "YaoFetchLogResponse{err=%d, data_len=%ld}", result_code.result_code_, data.get_position());
        return buf;
      }
    };
    ...
    class ObLsyncServer: public ObBaseServer
    {
      public:
        ...
        //bool handleBatchPacket(yynet::Connection *connection, ObPacketQueue &packetQueue);
