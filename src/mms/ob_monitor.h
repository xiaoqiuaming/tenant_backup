...
namespace oceanbase
{
  namespace mms
  {
    ...
    {
      mms_key()
      {app_name = NULL, instance_name = NULL;};
      char *app_name;
      char *instance_name;
    ...
    class ObMonitor : public yynet::IPacketQueueHandler
    {
      public:
        ObMonitor();
        ~ObMonitor();
        ...
        int node_register(const int32_t version, common::ObDataBuffer& in_buff, yynet::Connection* conn,
        ...
        int slave_failure(const int32_t version, common::ObDataBuffer& in_buff, yynet::Connection* conn,
            const uint32_t channel_id, common::ObDataBuffer& out_buff);
