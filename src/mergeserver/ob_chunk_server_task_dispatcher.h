...
namespace oceanbase
{
  namespace mergeserver
  {
    ...
    private:
      ...
      //mod zhaoqiong [MultiUPS] [CS_Tablet_Dispatch] 20150701:b
      int32_t old_select_cs(ObTabletLocationList & list, int32_t cluster_id);
      //mod:e
      // using new balance for get request
      //mod zhaoqiong [MultiUPS] [CS_Tablet_Dispatch] 20150701:b
      int32_t new_select_cs(ObTabletLocationList & list, int32_t cluster_id);
      //mod:e

      //add zhaoqiong [MultiUPS] [CS_Tablet_Dispatch] 20150701:b
      int32_t inner_select_cs(ObTabletLocationList & list, const int32_t replica_count_in,ObMergerServerCounter * counter);
      int32_t inner_select_cs(ObChunkServerItem * replicas_in_out, const int32_t replica_count_in,ObMergerServerCounter * counter);
      //add:e
    private:
    ...
    public:
      void set_local_ip(int32_t local_ip)
      { local_ip_ = local_ip; }
