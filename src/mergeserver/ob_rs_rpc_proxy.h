...
namespace oceanbase
{
  ...
  namespace mergeserver
  {
    ...
    public:
      ...
      int alter_group(const common::ObString &group_name, const int64_t idx);
      ...
      //[view]
      int create_view(bool do_replace, const common::TableSchema &table_schema);
      int drop_view(bool if_exists, const common::ObStrings &views);
