...
//add 20150617:e
#include "ob_ms_partition_release_task.h"//add wuna [MultiUps] [part_cache] 20160118
  ...
  namespace mergeserver
  {
    ...
    class ObMergeServerService: public ObVersionProvider
    {
      ...
      public:
        ...
        const ObServer &get_root_server() const;
        //add 20160228:e
      ...
      private:
        ...
        int set_tx_system_param(ObSQLSessionInfo &session);
        ...
        int ms_fetch_collection_list(
            ...
            common::ObDataBuffer& out_buffer,
            const int64_t timeout_us);
        int ms_fetch_range_collection_list(
            const int64_t receive_time,
            const int32_t version,
            const int32_t channel_id,
            easy_request_t* req,
            ...
            common::ObDataBuffer& out_buffer,
            const int64_t timeout_us);
        int ms_put_analysised_table_sinfo_into_cache(
            const int64_t receive_time,
            const int32_t version,
            const int32_t channel_id,
            easy_request_t* req,
            ...
            common::ObDataBuffer& out_buffer,
            const int64_t timeout_us);
        int ms_put_analysised_column_sinfo_into_cache(
            const int64_t receive_time,
            const int32_t version,
            const int32_t channel_id,
            easy_request_t* req,
      ...
      private:
        ...
        //add liu jun.[MultiUPS] [part_cache] 20150617:b
        ObMsPartitionTask part_task_;
        //add 20150617:e
        ObMsPartitionReleaseTask part_release_task_;//add wuna [MultiUps] [part_cache] 20160118
        ...
        ObMsFetchUpsTask ms_fetch_ups_task_;
        //add 20160803:e
        //add zhaoqiong [Schema Manager] 20150327:b
    ...
    {
      lease_expired_time_ = yysys::CTimeUtil::getTime() + delay;
    }

    inline bool ObMergeServerService::check_lease(void) const
    {
      return yysys::CTimeUtil::getTime() <= lease_expired_time_;
    }
