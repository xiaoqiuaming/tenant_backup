...
//yynet::IPacketHandler::HPRetCode ObCommonSqlRpcEvent::handlePacket(yynet::Packet * packet, void *args)
//{
//  UNUSED(packet);
//  UNUSED(args);
//  YYSYS_LOG(ERROR, "unexpected path not implenmented in common rpc event");
...
{
  end_time_us_ = yysys::CTimeUtil::getTime();
}
