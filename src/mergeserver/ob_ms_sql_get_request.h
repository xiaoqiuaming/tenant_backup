...
namespace oceanbase
{
  namespace mergeserver
  {
    ...
    public:
      ...
      inline void  get_stmt_type(ObBasicStmt::StmtType & stmt_type);
    public:
      /*
    ...
    //add shili [MultiUPS] [PHYSICAL_PLAN_TRANSFORM] 20150612:b
    inline void  ObMsSqlGetRequest::set_stmt_type(ObBasicStmt::StmtType stmt_type)
    {
      stmt_type_=stmt_type;
    }
    inline void  ObMsSqlGetRequest::get_stmt_type(ObBasicStmt::StmtType & stmt_type)
    {
