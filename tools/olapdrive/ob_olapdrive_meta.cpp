...
{ 
  namespace olapdrive 
  {
    ...
    int ObOlapdriveMeta::init()
    {
      ...
      if (OB_SUCCESS != ret)
      {
        YYSYS_LOG(WARN, "failed to init rowkey meta");
      }
      else
      {
        ...
        if (OB_SUCCESS != ret)
        {
          YYSYS_LOG(WARN, "fail to create campaign hash table");
        }
        else
        {
          ...
          if (OB_SUCCESS != ret)
          {
            YYSYS_LOG(WARN, "fail to create adgroup hash table");
          }
        }
      }
                                        ...
                                        int64_t& value)
    {
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        case ObExtendType:
          ...
          {
            YYSYS_LOG(WARN, "row doesn't exist for get rowkey range");
            ret = OB_ERROR;
          }
          break;
        ...
        case ObSeqType:
        default:
          YYSYS_LOG(WARN, "invalid cell info type %d", cell_type);
          ret = OB_ERROR;
          break;
        }
      }
    ...
    int ObOlapdriveMeta::read_rowkey_meta(ObScanner& scanner)
    {
           ...
           iter++, index++)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          default:
            YYSYS_LOG(WARN, "more than 8 cell returned for get rowkey meta");
            ret = OB_ERROR;
            break;
          }
        }
    ...
    int ObOlapdriveMeta::init_rowkey_meta()
    {
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        {
          YYSYS_LOG(WARN, "key meta table schema is invalid, key_meta_schema=%p", 
                    key_meta_schema);
          ret = OB_ERROR;
        }
      }
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        if (OB_SUCCESS != ret)
        {
          YYSYS_LOG(WARN, "failed to get cell from merge server, rowkey: %s",
              to_cstring(row_key));
        }
      }     
                                        ...
                                        const int64_t value)
    {
      ...
      case ObMaxType:
      default:
        YYSYS_LOG(WARN, "wrong object type %d for store rowkey meta", type);
        ret = OB_ERROR;
        break;
      }
    ...
    int ObOlapdriveMeta::write_rowkey_meta()
    {
      ...
      if (NULL == mutator)
      {
        YYSYS_LOG(ERROR, "failed to get thread local mutator, mutator=%p", mutator);
        ret = OB_ALLOCATE_MEMORY_FAILED;
      }
        ...
        if (NULL != key_meta_schema)
        {
          ...
          for (int64_t i = 0; i < column_size && OB_SUCCESS == ret; ++i)
          {
            if (NULL != &column_schema[i])
            {
              ...
              default:
                YYSYS_LOG(WARN, "more than 8 cells to store for set rowkey meta");
                ret = OB_ERROR;
                break;
              }
        ...
        ObCampaign& campaign)
    {
      ...
      if (HASH_NOT_EXIST == hash_err)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          {
            YYSYS_LOG(WARN, "failed to set campaign into hash map, hash_err=%d", 
                      hash_err);            
          }
        }
      }
      ...
      {
        YYSYS_LOG(WARN, "failed to get campaign from hash map, hash_err=%d", 
                  hash_err);
        ret = OB_ERROR;
      }
        ...
        ObCampaign& campaign)
    {
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        {
          YYSYS_LOG(WARN, "campaign table schema is invalid, campaign_schema=%p", 
                    campaign_schema);
          ret = OB_ERROR;
        }
      }
    ...
    int ObOlapdriveMeta::read_campaign(ObScanner& scanner, ObCampaign& campaign)
    {
           ...
           iter++, index++)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          default:
            YYSYS_LOG(WARN, "more than 5 cells returned for get campaign data");
            ret = OB_ERROR;
            break;
          }
        }
        ...
        if (NULL != campaign_schema)
        {
          ...
          for (int64_t i = 0; i < column_size && OB_SUCCESS == ret; ++i)
          {
            if (NULL != &column_schema[i])
            {
              ...
              default:
                YYSYS_LOG(WARN, "more than 5 cells to store for set campaign data");
                ret = OB_ERROR;
                break;
              }
        ...
        ObAdgroup& adgroup)
    {
      ...
      if (HASH_NOT_EXIST == hash_err)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          if (HASH_INSERT_SUCC != hash_err)
          {
            YYSYS_LOG(WARN, "failed to set adgroup into hash map, hash_err=%d", 
                      hash_err);            
          }
        }
      }
      ...
      {
        YYSYS_LOG(WARN, "failed to get adgroup from hash map, hash_err=%d", 
                  hash_err);
        ret = OB_ERROR;
      }
        ...
        ObAdgroup& adgroup)
    {
      ...
      if (OB_SUCCESS == ret)
      {
        ...
        {
          YYSYS_LOG(WARN, "adgroup table schema is invalid, adgroup_schema=%p", 
                    adgroup_schema);
          ret = OB_ERROR;
        }
      }
    ...
    int ObOlapdriveMeta::read_adgroup(ObScanner& scanner, ObAdgroup& adgroup)
    {
           ...
           iter++, index++)
      {
        ...
        if (OB_SUCCESS == ret)
        {
          ...
          default:
            YYSYS_LOG(WARN, "more than 4 cells returned for get adgroup data");
            ret = OB_ERROR;
            break;
          }
        }
        ...
        if (NULL != adgroup_schema)
        {
          ...
          for (int64_t i = 0; i < column_size && OB_SUCCESS == ret; ++i)
          {
            if (NULL != &column_schema[i])
            {
              ...
              default:
                YYSYS_LOG(WARN, "more than 4 cells to store for set adgroup data");
                ret = OB_ERROR;
                break;
              }
