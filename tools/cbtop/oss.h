...
typedef int32_t  OSSPID;
typedef uint32_t OSSTID;
...
uint32_t ossGetLastError();
void ossSleep(uint32_t milliseconds);
void ossPanic () ;
...
int32_t ossOnceRun(ossOnce* control, void (*func)(void));
