...
//#pragma once
#ifndef CBTOP_BSONOBJ_H_
#define CBTOP_BSONOBJ_H_
//#if defined (CB_ENGINE) || defined (CB_CLIENT)
...
#pragma pack()
    ...
    private:
        CB_EXPORT static bool _jsCompatibility;
