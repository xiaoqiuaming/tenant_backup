...
#include "common_decimal_fun.h"
    ...
    #define CB_EXPORT
#else
    #ifdef CB_STATIC_BUILD
        #define CB_EXPORT
    #elif defined(CB_DLL_BUILD)
...
#ifdef __cplusplus
#define CB_EXTERN_C_START extern "C" {
#define CB_EXTERN_C_END }
#else
#define CB_EXTERN_C_START
#define CB_EXTERN_C_END
#endif
 ...
 */
CB_EXPORT void bson_iterator_dispose(bson_iterator*);
/**
 ...
 */
CB_EXPORT time_t bson_oid_generated_time( bson_oid_t *oid ); /* Gives the time the OID was created */
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT void bson_init_size( bson *b, int size );
 ...
 */
CB_EXPORT int bson_copy( bson *out, const bson *in ); /* puts data in new buffer. NOOP if out==NULL */
 ...
 * @return BSON_OK or BSON_ERROR.
*/
CB_EXPORT int bson_append_string( bson *b, const char *name, const char *str );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_string_n( bson *b, const char *name, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_symbol( bson *b, const char *name, const char *str );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_symbol_n( bson *b, const char *name, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_code( bson *b, const char *name, const char *str );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_code_n( bson *b, const char *name, const char *str, int len );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_code_w_scope_n( bson *b, const char *name, const char *code, int size, const bson *scope );
 ...
 * @return BSON_OK or BSON_ERROR.
 */
CB_EXPORT int bson_append_bool( bson *b, const char *name, const bson_bool_t v );
