...
#define CB_DECIMAL_POS             0x0000
#define CB_DECIMAL_NEG             0x4000
#define CB_DECIMAL_SPECIAL_SIGN    0xC000

#define CB_DECIMAL_SPECIAL_NAN     0x0000
#define CB_DECIMAL_SPECIAL_MIN     0x0001
#define CB_DECIMAL_SPECIAL_MAX     0x0002

#define DECIMAL_DSCALE_MASK         0x3FFF


#define CB_DECIMAL_DBL_DIG        ( DBL_DIG )
