...
#include <string.h>
    ...
    #ifndef CB_INLINE
       #define CB_INLINE static __inline__
    #endif
    #define CB_EXPORT
#else
    #ifndef CB_INLINE
       #define CB_INLINE static
    #endif
...
/** \fn int base64Encode ( const char *s, int in_size, char *out, int out_size )
    ...
    \endcode
*/
CB_EXPORT int base64Encode ( const char *s, int in_size, char *out, int out_size ) ;
...
/** \fn int base64Decode ( const char *s, char *out, int out_size ) 
   ...
   \endcode
*/
CB_EXPORT int base64Decode ( const char *s, char *out, int out_size ) ;
...
*/
CB_EXPORT int getEnBase64Size ( int size ) ;
...
*/
CB_EXPORT int getDeBase64Size ( const char *s ) ;
