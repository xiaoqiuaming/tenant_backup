...
DEFINE_SERIALIZE(TaskCounter)
{
  ...
  if (ret != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "serialize total count failed:count[%ld], ret[%d]", total_count_, ret);
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize wait count failed:count[%ld], ret[%d]", wait_count_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize doing count failed:count[%ld], ret[%d]", doing_count_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize finish count failed:count[%ld], ret[%d]", finish_count_, ret);
    }
  }
  return ret;
}
...
DEFINE_DESERIALIZE(TaskCounter)
{
  ...
  if (ret != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "deserialize total count failed:ret[%d]", ret);
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize wait count failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize finish count failed:ret[%d]", ret);
    }
  }
  return ret;
}
...
int TaskInfo::set_param(const ObScanParam & param)
{
  ...
  if (temp != NULL)
  {
    ...
    {
      YYSYS_LOG(ERROR, "check param buffer new failed:buffer[%p], temp[%p]", param_buffer_, temp);
      ret = OB_ERROR;
    }
  }
  else
  {
    YYSYS_LOG(ERROR, "check ob malloc failed:buffer[%p], size[%ld]", param_buffer_, size);
    ret = OB_ERROR;
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serailize param failed:ret[%d]", ret);
    }
    else
    {
      pos = 0;
      ...
      if (ret != OB_SUCCESS)
      {
        YYSYS_LOG(ERROR, "deserialize scan param failed:ret[%d]", ret);
      }
    }
  }
  return ret;
...
DEFINE_SERIALIZE(TaskInfo)
{
  ...
  if (ret != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "serialize task timestamp failed:timestamp[%ld], ret[%d]", timestamp_, ret);
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize task token failed:token[%ld], ret[%d]", task_token_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize task id failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize task limit failed:limit[%lu], ret[%d]", task_limit_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize server index failed:index[%lu], ret[%d]", first_index_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize table_id failed:table_id[%lu], ret[%d]", table_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize table name failed:ret[%d]",ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize location failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "serialize scan param failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
...
DEFINE_DESERIALIZE(TaskInfo)
{
  ...
  if (ret != OB_SUCCESS)
  {
    YYSYS_LOG(ERROR, "deserialize task timestamp failed:ret[%d]", ret);
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize task token failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize task id failed:ret[%d]", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize task limit failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize first server index failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize table_id failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserializ table name failed");
    }
    else
    {
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize location failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (ret != OB_SUCCESS)
    {
      YYSYS_LOG(ERROR, "deserialize scan param failed:task[%lu], ret[%d]", task_id_, ret);
    }
  }
