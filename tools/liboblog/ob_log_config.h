  ...
  namespace liboblog
  {
    ...
    class ObLogConfig
    {
      ...
      private:
        ...
        /// @brief Initialize map config based on yysys::CConfig
        /// @param map_config target map config
        /// @param yysys_config target yysys CConfig
        /// @retval OB_SUCCESS on success
        /// @retval ! OB_SUCCESS on fail
        int init_map_config_(ConfigMap &map_config, yysys::CConfig &yysys_config) const;

        /// @brief Initialize specific map config section based on yysys::CConfig
        /// @param map_config target map config
        /// @param yysys_config target yysys::CConfig
        /// @param section specific section
        /// @retval OB_SUCCESS on success
        /// @retval ! OB_SUCCESS on fail
        int init_map_config_section_(ConfigMap &map_config, yysys::CConfig &yysys_config, const char *section) const;
      ...
      private:
        ...
        yysys::CConfig yysys_config_;    ///< yysys container for configuration
    ...
    {
      YYSYS_LOG(INFO, "tb_select=[%s]", tb_select_cstr);
