...
int SqlTest::init()
{
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    {
      YYSYS_LOG(WARN, "failed to parse schema file, schema_file=%s, err=%d",
    ...
    if (0 == ret)
    {
      ...
      if (0 != ret)
      {
        YYSYS_LOG(WARN, "failed to init sqltest schema, ret=%d", ret);
      }
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (0 != ret)
    {
      YYSYS_LOG(WARN, "failed to init sql builder, ret=%d", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (0 != ret)
    {
      YYSYS_LOG(WARN, "failed to init sqltest_pattern, ret=%d", ret);
    }
    else
    {
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (0 != ret)
    {
      YYSYS_LOG(WARN, "failed to init sqltest dao, ret=%d", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (0 != ret)
    {
      YYSYS_LOG(WARN, "failed to init key gen, ret=%d", ret);
    }
  }
  ...
  if (OB_SUCCESS == ret)
  {
    ...
    if (OB_SUCCESS != ret)
    {
      YYSYS_LOG(WARN, "failed to init read worker, ret=%d", ret);
    }
    else
    {
      ...
      if (OB_SUCCESS != ret)
      {
        YYSYS_LOG(WARN, "failed to init write worker, ret=%d", ret);
      }
    }
  }
