...
#ifndef MC
#define MC(src, len) memcpy((str+pos), (src), (len))
#endif
...
struct TableParam {
  TableParam() 
    : //input_column_nr(0), ////delete by zhuxh:20150727
      ...
      is_delete(false),
      is_rowbyrow(false),
      trim_flag(2), //add by pangtz:20141126 添加trim参数
  ...
  char *custom_column_str;
  vector<int32_t> hex_column;
  vector<bool> is_hex_column;
};
