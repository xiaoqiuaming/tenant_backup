...
enum ImportErrorType{
  NORMAL = 0, //����
  TABLE_NOT_EXIST = 1, //��������
  DATAFLIE_NOT_EXIST = 2, //�����ļ�������
  DATAFLIE_COLUMN_NUM_ERROR = 3, //�ֶ�������
  DATA_ERROR = 4, //������
  NOT_NULL_CONSTRAIN_ERROR = 5, //�ǿ�Լ������
  SYSTEM_ERROR = 6, //ϵͳ����
  LOCK_CONFLICT = 7, //����ͻ
  VARCHAR_OVER_FLOW = 8, //�ַ�������
  OVER_MAX_ROWKEY_NUM = 9, //�����������������
  LINE_TOO_LONG = 10, //һ�����ݹ���
  RS_ERROR = 11, //rs�쳣
  CONF_FILE_ERROR = 12, //�����ļ�����
  DELETE_ERROR = 13, //����ɾ������
  TABLE_CONF_NOT_EXIST = 14, //�����ļ�������
  MEMORY_SHORTAGE = 15, //�������ڴ治��
  WRONG_TIME_FORMAT = 16, //�����ʱ���ʽ
  READ_FILE_ERROR = 17, //���ļ�����
