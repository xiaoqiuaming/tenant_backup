...
private:
  ...
  struct ProduceMark
  {
    ...
    yysys::CThreadMutex s_index_lock_;
    //add qianzm [export_by_tablets] 20160415
    string err_sql_;
    int tablet_index_;
    //add 20160415:e
...
private:
  ...
  //add by liyongfeng:20141120
  yysys::CThreadMutex allocator_lock_;
  ...
  yysys::CThreadMutex tablet_cache_lock_;
  //add:e

  std::vector<oceanbase::common::ObServer> ms_vec_;
  ErrorCode *err_code_;

  yysys::CThreadMutex rowkey_idx_inited_lock_;
  ...
  yysys::CThreadMutex rowformator_result_field_lock_;
