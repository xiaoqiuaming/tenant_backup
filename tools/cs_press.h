 ...
 *
 *  Version: $Id: cs_press.h 2010��11��16�� 11ʱ02��09�� qushan Exp $
 *
 *  Authors:
...
#include <yysys.h> // for default_runnable
...
class Metrics
{
  public:
    ...
    void start() { reset(); time_start_ = yysys::CTimeUtil::getTime(); }
    void stop() { time_stop_ = yysys::CTimeUtil::getTime(); }
...
class Worker : public yysys::CDefaultRunnable
{
  public:
