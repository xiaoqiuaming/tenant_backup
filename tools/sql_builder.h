...
#define TABLE_BUCKET 1024
typedef ObHashSet<uint64_t, hash::NoPthreadDefendMode> TableIdSet;
...
public:
    ...
    int ups_mutator_to_sql(uint64_t seq, ObUpsMutator &mutator, vector<string> &vector, CommonSchemaManagerWrapper *schema_manager, TableIdSet *table_set);
};
