...
namespace oceanbase
{
  namespace mergeserver
  {
    class MockMergeServer : public MockServer
    {
      ...
      private:
        int ms_scan(const int64_t start_time,const int32_t version,const int32_t channel_id,yynet::Connection* connection,common::ObDataBuffer& in_buffer,common::ObDataBuffer& out_buffer,const int64_t timeout_us);
      private:
