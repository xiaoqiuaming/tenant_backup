...
cp /usr/lib64/libboost_regex.so.5             $RPM_BUILD_ROOT%{_prefix}/lib/
cp /usr/lib64/libboost_program_options.so.5   $RPM_BUILD_ROOT%{_prefix}/lib/
cp /usr/lib64/mysql/libmysqlclient.so.16      $RPM_BUILD_ROOT%{_prefix}/lib/
cp /usr/lib64/libicui18n.so.42                $RPM_BUILD_ROOT%{_prefix}/lib/
cp /usr/lib64/libicuuc.so.42                  $RPM_BUILD_ROOT%{_prefix}/lib/
cp /usr/lib64/libicudata.so.42                $RPM_BUILD_ROOT%{_prefix}/lib/

#/usr/sbin/prelink -u $RPM_BUILD_ROOT%{_prefix}/lib/libicui18n.so.42
#/usr/sbin/prelink -u $RPM_BUILD_ROOT%{_prefix}/lib/libicudata.so.42
#/usr/sbin/prelink -u $RPM_BUILD_ROOT%{_prefix}/lib/libicuuc.so.42
#/usr/sbin/prelink -u $RPM_BUILD_ROOT%{_prefix}/lib/libmysqlclient.so.16
#/usr/sbin/prelink -u $RPM_BUILD_ROOT%{_prefix}/lib/libboost_program_options.so.5
%clean
...
%{_prefix}/bin/ob_export
%{_prefix}/bin/rs_admin
%{_prefix}/lib/libicui18n.so.42
%{_prefix}/lib/libicudata.so.42
%{_prefix}/lib/libicuuc.so.42
%{_prefix}/lib/libmysqlclient.so.16
%{_prefix}/lib/libboost_program_options.so.5
%{_prefix}/lib/libboost_regex.so.5
