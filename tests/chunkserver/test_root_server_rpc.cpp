  ...
  namespace tests
  {
    namespace chunkserver
    {
      ...
      public:
        ...
        class MockServer : public ObSingleServer
        {
          public:
            ...
            int handle_report_tablets(ObPacket* ob_packet)
            {
              ...
              if (NULL == data)
              {
                YYSYS_LOG(ERROR, "data is NUll should not reach this");
                ret = OB_ERROR;
              }
              else
              {
                ...
                if (OB_SUCCESS == ret)
                {
                  ...
                  YYSYS_LOG(INFO, "tablets size: %ld", tablet_list.get_tablet_size());
                ...
                if (OB_SUCCESS == ret)
                {
                  ...
                  YYSYS_LOG(INFO, "timestamp: %ld", time_stamp);
                ...
                if (NULL != thread_buffer)
                {
                  ...
                  YYSYS_LOG(DEBUG, "handle tablets report packet");
            ...
            int handle_schema_changed(ObPacket* ob_packet)
            {
              ...
              else
              {
                ...
                if (NULL != thread_buffer)
                {
                  ...
                  YYSYS_LOG(DEBUG, "handle schema changed");
        ...
        class MockServerRunner : public yysys::Runnable
        {
          public:
      ...
      TEST_F(TestRootServerRpcStub, test_report_tablets)
      {
        ...
        yysys::CThread test_root_server_thread;
