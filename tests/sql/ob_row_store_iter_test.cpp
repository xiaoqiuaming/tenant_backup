...
TEST_F(ObRowStoreIteratorTest, iter_8_test)
{
  ...
  YYSYS_LOG(INFO, "per line size=%ld", stored_row->compact_row_size_ + sizeof(ObRowStore::StoredRow));
  YYSYS_LOG(INFO, "total size=%ld", row_count * (stored_row->compact_row_size_ + sizeof(ObRowStore::StoredRow)));
