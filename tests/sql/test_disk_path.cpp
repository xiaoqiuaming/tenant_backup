...
namespace oceanbase 
{
  namespace sstable
  {
      ...
      const int64_t path_len)
    {
      ...
      if (disk_no < 0 || NULL == path || path_len < 0)
      {
        YYSYS_LOG(WARN, "get_sstable_bypass_directory invalid arguments, "
      ...
      else
      {
        ...
        if (bufsiz + 1 > path_len)
        {
          YYSYS_LOG(WARN, "get_sstable_bypass_directory, path_len=%ld <= bufsiz=%d", path_len, bufsiz);
          ret = OB_SIZE_OVERFLOW;
        }
      }
      ...
      const char* sstable_name, char *path, const int64_t path_len)
    {
      ...
      {
        YYSYS_LOG(WARN, "get_bypass_sstable_path invalid arguments, "
      ...
      else
      {
        ...
        if (bufsiz + 1 > path_len)
        {
          YYSYS_LOG(WARN, "get_bypass_sstable_path, path_len=%ld <= bufsiz=%d", 
              path_len, bufsiz);
          ret = OB_SIZE_OVERFLOW;
        }
      }
