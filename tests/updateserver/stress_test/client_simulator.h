...
class ApplyRunnable : public yysys::CDefaultRunnable
{
  public:
    ApplyRunnable(int thread_no = 1) : yysys::CDefaultRunnable(thread_no) {}
    ~ApplyRunnable() {}
...
class USScanRunnable : public yysys::CDefaultRunnable
{
  public:
    USScanRunnable(int thread_no = 1) : yysys::CDefaultRunnable(thread_no) {}
    ~USScanRunnable() {}
    virtual void run(yysys::CThread* thread, void* arg);
  private:
...
class USGetRunnable : public yysys::CDefaultRunnable
{
  public:
    USGetRunnable(int thread_no = 1) : yysys::CDefaultRunnable(thread_no) {}
    ~USGetRunnable() {}
    virtual void run(yysys::CThread* thread, void* arg);
  private:
...
class GI
{
  public:
    ...
    yysys::CDefaultRunnable* runnable() {return run_;}
  private:
    Param param_;
    OBAPI obapi_;
    Random random_;
