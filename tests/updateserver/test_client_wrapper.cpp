  ...
  namespace updateserver
  {
    namespace test
    {
      ...
      TEST_F(TestClientWrapper,get)
      {
        ...
        delete[] cell;
        YYSYS_LOG(INFO,"get_param cell_size=%lu,row_size=%lu",get_param.get_cell_size(),get_param.get_row_size()); 
        ...
        YYSYS_LOG(INFO,"i=%d",i);
        YYSYS_LOG(INFO,"table_id=%u,column_id=%u",cell_info->table_id_,cell_info->column_id_);
