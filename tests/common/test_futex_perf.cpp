...
class TestSignal : public yysys::CDefaultRunnable
{
  public:
    ...
    void run(yysys::CThread * thread, void * arg)
    {
      ...
      YYSYS_LOG(INFO, "signal counter=%ld", counter);
...
class TestWait : public yysys::CDefaultRunnable
{
  public:
    ...
    void run(yysys::CThread * thread, void * arg)
    {
      ...
      YYSYS_LOG(INFO, "wait counter=%ld", counter);
...
TEST(pthread_cond, perf)
{
  ...
  YYSYS_LOG(INFO, "signal thread: %d  wait thread: %d  "
